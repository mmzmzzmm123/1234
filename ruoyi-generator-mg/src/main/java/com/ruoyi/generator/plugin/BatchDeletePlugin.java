...
public class BatchDeletePlugin extends AbstractClassPlugin {
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
		...
		Method mBatchDelete = JavaElementGeneratorTools.generateMethod(METHOD_BATCH_INSERT, JavaVisibility.DEFAULT,
				FullyQualifiedJavaType.getIntInstance(), new Parameter(listType, "ids", "@Param(\"ids\")")
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
		...
		batchDeleteEle
				.addElement(new TextElement("delete from " + introspectedTable.getFullyQualifiedTableNameAtRuntime()
