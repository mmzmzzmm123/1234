...
public class CustomizedCommentGenerator implements CommentGenerator {
    ...
    private FullyQualifiedJavaType STRING_JAVA_TYPE = new FullyQualifiedJavaType(
    ...
    private void addFieldColumnComment(JavaElement element, IntrospectedTable introspectedTable,
        ...
        element.addJavaDocLine(String.format(" * 字段名： %s.%s",
    ...
    private void addTableComment(JavaElement element, IntrospectedTable introspectedTable) {
        ...
        element.addJavaDocLine(" *<br>");
        element.addJavaDocLine(
            String.format(" * 数据表： %s", introspectedTable.getFullyQualifiedTable()));
        element.addJavaDocLine(" *");
        element.addJavaDocLine(" */");
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable,
        ...
        String remarks = introspectedColumn.getRemarks();
        if (StringUtility.stringHasValue(remarks)) {
            List<String> remarkLines = Lists
                .newArrayList(remarks.split(System.getProperty("line.separator")));
    ...
    public void addGetterComment(Method method, IntrospectedTable introspectedTable,
        ...
        method.addJavaDocLine(String.format(" * 字段名： %s.%s",
            introspectedTable.getFullyQualifiedTable(), introspectedColumn.getActualColumnName()));
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        compilationUnit.addImportedType(
            new FullyQualifiedJavaType("com.vocust.framework.common.annotation.Description"));
        compilationUnit
            .addImportedType(new FullyQualifiedJavaType("javax.validation.constraints.NotNull"));
        compilationUnit
            .addImportedType(new FullyQualifiedJavaType("javax.validation.constraints.NotBlank"));
    }
