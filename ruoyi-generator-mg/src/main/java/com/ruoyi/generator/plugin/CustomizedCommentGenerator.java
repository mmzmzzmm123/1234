...
public class CustomizedCommentGenerator implements CommentGenerator {
	...
	private void addTableComment(JavaElement element, IntrospectedTable introspectedTable) {
		...
		if (StringUtils.isNotEmpty(introspectedTable.getRemarks())) {
			element.addAnnotation(String.format("@Description({\"{}\"})", introspectedTable.getRemarks()));
		}
	}
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable,
		...
		if (StringUtility.stringHasValue(remarks)) {
			...
			field.addAnnotation(String.format("@Description({\"{}\"})", StringUtils.join(remarkLines, "\", \"")));
		}
	...
	public void addJavaFileComment(CompilationUnit compilationUnit) {
		compilationUnit
				.addImportedType(new FullyQualifiedJavaType("com.vocust.framework.common.annotation.Description"));
