...
public class ExcelUtil<T> {
    ...
    public void createTitle() {
        if (StringUtils.isNotEmpty(this.title)) {
            ...
            this.sheet.addMergedRegion(new CellRangeAddress(titleRow.getRowNum(), titleRow.getRowNum(), titleRow.getRowNum(),
                    this.fields.size() - 1));
        }
    }
    ...
    public List<T> importExcel(InputStream is, int titleNum) throws Exception {
        return this.importExcel(StringUtils.EMPTY, is, titleNum);
    }
    ...
    public List<T> importExcel(String sheetName, InputStream is, int titleNum) throws Exception {
        ...
        if (isXSSFWorkbook) {
            pictures = getSheetPictures07((XSSFSheet) sheet, (XSSFWorkbook) this.wb);
        } else {
            pictures = getSheetPictures03((HSSFSheet) sheet, (HSSFWorkbook) this.wb);
        }
    ...
    public Result exportExcel(List<T> list, String sheetName) {
        return this.exportExcel(list, sheetName, StringUtils.EMPTY);
    }
    ...
    public void exportExcel(HttpServletResponse response, List<T> list, String sheetName) {
        this.exportExcel(response, list, sheetName, StringUtils.EMPTY);
    }
    ...
    public Result importTemplateExcel(String sheetName) {
        return this.importTemplateExcel(sheetName, StringUtils.EMPTY);
    }
    ...
    public void fillExcelData(int index, Row row) {
        ...
        int endNo = Math.min(startNo + sheetSize, this.list.size());
        ...
        if (ColumnType.STRING == attr.cellType()) {
            ...
            if (StringUtils.isNotEmpty(imagePath)) {
                ...
                getDrawingPatriarch(cell.getSheet()).createPicture(anchor,
                        cell.getSheet().getWorkbook().addPicture(data, this.getImageType(data)));
            }
        }
    }
    ...
    public void setDataValidation(Excel attr, Row row, int column) {
        if (attr.name().indexOf("注：") >= 0) {
            ...
            // 设置列宽
            this.sheet.setColumnWidth(column, (int) ((attr.width() + 0.72) * 256));
        }
