...
public class WxMaServiceUtil {
    ...
    @Bean(name = "customerWxMaService")
    public WxMaService customerWxMaService(){
        return getMaServiceByName("office");
    }

    public WxMaService getMaServiceByName(String name) {
    ...
    public WxMaService getMaServiceById(String appid) {
