...
public class ComUtil {
    ...
    public static List<String> jsonToListString(String str){
        try{
            return JSON.parseArray(str).toJavaList(String.class);
        }catch (Exception e){
    ...
    public static List<Integer> jsonToListInteger(String str){
        try{
            return JSON.parseArray(str).toJavaList(Integer.class);
        }catch (Exception e){
    ...
    public static List<Object> jsonToListObject(String str){
        try{
            return JSON.parseArray(str).toJavaList(Object.class);
        }catch (Exception e){
    ...
    public static String getValueByIndex(HashMap<Integer, String> list, String categoryIdStr){
        ...
        List<Integer> idList = ComUtil.stringToArray(categoryIdStr);
    ...
    public static int getRate(BigDecimal b1, BigDecimal b2){
        ...
        if(b2.equals(b1)){
            //数值一样，说明没有增长
            return NewConstants.NUM_ZERO;
        }

        if(b2.equals(BigDecimal.ZERO)){
            //b2是0
            return NewConstants.NUM_ONE_HUNDRED;
        }
...
//        setScaler(1,BigDecimal.ROUND_HALF_DOWN);//四舍五入，2.35变成2.3，如果是5则向下舍
    ...
    public static String getOrderNoPrefix(String payType){
        switch (payType){
            case NewConstants.PAY_TYPE_WE_CHAT:
                return NewConstants.ORDER_NO_PREFIX_WE_CHAT;
                //其他平台
            default:
                return NewConstants.ORDER_NO_PREFIX_H5;
        }
    }
    ...
    public static String getSign(Map<String, Object> map, String signKey){
        String result = ComUtil.mapToStringUrl(map) + "&key=" + signKey;
