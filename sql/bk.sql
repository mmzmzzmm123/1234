...
DROP TABLE IF EXISTS `bk_label`;
CREATE TABLE `bk_label`
(
    `id`                int          NOT NULL AUTO_INCREMENT COMMENT 'id',
    `sort_id`           int          NOT NULL COMMENT '分类ID',
...
DROP TABLE IF EXISTS `bk_tree_hole`;
CREATE TABLE `bk_tree_hole`
(
    `id`          int         NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='树洞';

DROP TABLE IF EXISTS `bk_wei_yan`;
CREATE TABLE `bk_wei_yan`
(
    `id`          int           NOT NULL AUTO_INCREMENT COMMENT 'id',
    `user_id`     int           NOT NULL COMMENT '用户ID',
    `like_count`  int           NOT NULL DEFAULT 0 COMMENT '点赞数',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='微言表';

DROP TABLE IF EXISTS `bk_web_info`;
CREATE TABLE `bk_web_info`
(
    `id`               int          NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `bk_resource_path`;
CREATE TABLE `bk_resource_path`
(
    `id`           int         NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='资源路径';

DROP TABLE IF EXISTS `bk_resource`;
CREATE TABLE `bk_resource`
(
    `id`            int          NOT NULL AUTO_INCREMENT COMMENT 'id',
    `user_id`       int          NOT NULL COMMENT '用户ID',
    `type`          varchar(32)  NOT NULL COMMENT '资源类型',
...
DROP TABLE IF EXISTS `bk_history_info`;
CREATE TABLE `bk_history_info`
(
    `id`          int          NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='历史信息';

DROP TABLE IF EXISTS `bk_family`;
CREATE TABLE `bk_family`
(
    `id`              int          NOT NULL AUTO_INCREMENT COMMENT 'id',
    `user_id`         int          NOT NULL COMMENT '用户ID',
...
DROP TABLE IF EXISTS `bk_im_chat_user_friend`;
CREATE TABLE `bk_im_chat_user_friend`
(
    `id`            int        NOT NULL AUTO_INCREMENT COMMENT 'id',
    `user_id`       int        NOT NULL COMMENT '用户ID',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='好友';

DROP TABLE IF EXISTS `bk_im_chat_group`;
CREATE TABLE `bk_im_chat_group`
(
    `id`             int         NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='聊天群';

DROP TABLE IF EXISTS `bk_im_chat_group_user`;
CREATE TABLE `bk_im_chat_group_user`
(
    `id`             int        NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='聊天群成员';

DROP TABLE IF EXISTS `bk_im_chat_user_message`;
CREATE TABLE `bk_im_chat_user_message`
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='单聊记录';

DROP TABLE IF EXISTS `bk_im_chat_user_group_message`;
CREATE TABLE `bk_im_chat_user_group_message`
(
    `id`          bigint        NOT NULL AUTO_INCREMENT COMMENT 'id',
    `group_id`    int           NOT NULL COMMENT '群ID',
    `from_id`     int           NOT NULL COMMENT '发送ID',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='群聊记录';


-- 第三步：执行初始化语句
INSERT INTO `bk_web_info` (`id`, `web_name`, `web_title`, `notices`, `footer`, `background_image`, `avatar`,
                           `random_avatar`, `random_name`, `random_cover`, `waifu_json`, `status`)
VALUES (1, 'Sara', 'Poetize', '[]', '云想衣裳花想容， 春风拂槛露华浓。', '', '', '[]', '[]', '[]', '{
  "mouseover": [
    {
      "selector": "#live2d",
      "text": [
...
INSERT INTO `bk_im_chat_group` (`id`, `group_name`, `master_user_id`, `introduction`, `notice`, `in_type`)
VALUES (-1, '公共聊天室', 1, '公共聊天室', '欢迎光临！', 0);

INSERT INTO `bk_im_chat_group_user` (`id`, `group_id`, `user_id`, `admin_flag`, `user_status`)
VALUES (1, -1, 1, 1, 1);
