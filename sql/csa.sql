...
-- ----------------------------
-- Table structure for csa_farm_zone
-- ----------------------------
DROP TABLE IF EXISTS `csa_farm_zone`;
CREATE TABLE `csa_farm_zone`  (
  ...
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分区名称',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
  `del_flag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  ...
  `remark` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '农场分区' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (1, '1', 'code', '分区代码', 'varchar(10)', 'String', 'code', '1', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (2, '1', 'name', '分区名称', 'varchar(50)', 'String', 'name', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (3, '1', 'status', '状态', 'char(1)', 'String', 'status', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'radio', 'sys_normal_disable', 5, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (4, '1', 'del_flag', '删除标志', 'char(1)', 'String', 'delFlag', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', NULL, 6, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (5, '1', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', NULL, 7, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (6, '1', 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'datetime', NULL, 8, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (7, '1', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'input', NULL, 9, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (8, '1', 'update_time', '更新时间', 'datetime', 'Date', 'updateTime', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'datetime', NULL, 10, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (9, '1', 'remark', '备注', 'varchar(500)', 'String', 'remark', '0', '0', NULL, '1', '1', '1', NULL, 'EQ', 'input', '', 11, 'admin', '2022-03-24 19:16:52', NULL, '2022-03-28 22:04:22');
INSERT INTO `gen_table_column` VALUES (10, '2', 'id', '菜地id', 'int(11)', 'Long', 'id', '1', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', NULL, 1, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (11, '2', 'code', '菜地编号', 'varchar(20)', 'String', 'code', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (13, '2', 'name', '菜地名称', 'varchar(50)', 'String', 'name', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', 4, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (14, '2', 'm2', '平方米', 'decimal(19,4)', 'BigDecimal', 'm2', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (15, '2', 'member_id', '会员', 'int(11)', 'Long', 'memberId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (16, '2', 'manager_id', '菜地管理员', 'int(11)', 'Long', 'managerId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (17, '2', 'worker_id', '工人', 'int(11)', 'Long', 'workerId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (18, '2', 'contacter_id', '客服人员', 'int(11)', 'Long', 'contacterId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (20, '2', 'is_farming', '耕作', 'char(1)', 'String', 'isFarming', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', 'sys_yes_no', 10, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (21, '2', 'is_selled', '售出', 'char(1)', 'String', 'isSelled', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', 'sys_yes_no', 11, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (22, '2', 'is_completed', '竣工', 'char(1)', 'String', 'isCompleted', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', 'sys_yes_no', 12, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (23, '2', 'status', '状态', 'char(1)', 'String', 'status', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'radio', 'sys_common_status', 13, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (24, '2', 'del_flag', '删除标志', 'char(1)', 'String', 'delFlag', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', NULL, 14, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (25, '2', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', NULL, 15, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
INSERT INTO `gen_table_column` VALUES (26, '2', 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'datetime', NULL, 16, 'admin', '2022-03-24 22:23:32', NULL, '2022-03-29 12:05:51');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, '0', '共享农场', 0, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 18:00:53');
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '信息部', 90, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 17:52:39');
INSERT INTO `sys_dept` VALUES (102, 100, '0,100', '客服部', 10, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 17:48:07');
INSERT INTO `sys_dept` VALUES (103, 100, '0,100', '研发部', 900, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 17:53:08');
INSERT INTO `sys_dept` VALUES (104, 100, '0,100', '管理办', 5, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 18:15:05');
INSERT INTO `sys_dept` VALUES (105, 101, '0,100,101', '测试部门', 3, '若依', '15888888888', 'ry@qq.com', '0', '2', 'admin', '2022-03-20 21:45:25', '', NULL);
INSERT INTO `sys_dept` VALUES (106, 100, '0,100', '财务部', 80, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 17:49:11');
INSERT INTO `sys_dept` VALUES (107, 101, '0,100,101', '运维部门', 5, '若依', '15888888888', 'ry@qq.com', '0', '2', 'admin', '2022-03-20 21:45:25', '', NULL);
INSERT INTO `sys_dept` VALUES (108, 100, '0,100', '销售部', 30, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 17:50:07');
INSERT INTO `sys_dept` VALUES (109, 100, '0,100', '现场部', 20, '', '', '', '0', '0', 'admin', '2022-03-20 21:45:25', 'admin', '2022-03-29 17:48:41');
...
INSERT INTO `sys_logininfor` VALUES (125, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '验证码已失效', '2022-03-27 22:19:37');
INSERT INTO `sys_logininfor` VALUES (126, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '0', '登录成功', '2022-03-27 22:19:40');
INSERT INTO `sys_logininfor` VALUES (127, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-28 19:23:45');
INSERT INTO `sys_logininfor` VALUES (128, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-28 20:52:45');
INSERT INTO `sys_logininfor` VALUES (129, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '0', '登录成功', '2022-03-28 21:18:59');
INSERT INTO `sys_logininfor` VALUES (130, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '0', '登录成功', '2022-03-28 21:52:49');
INSERT INTO `sys_logininfor` VALUES (131, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '验证码已失效', '2022-03-29 10:27:46');
INSERT INTO `sys_logininfor` VALUES (132, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '验证码错误', '2022-03-29 10:27:49');
INSERT INTO `sys_logininfor` VALUES (133, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '0', '登录成功', '2022-03-29 10:27:53');
INSERT INTO `sys_logininfor` VALUES (134, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '0', '登录成功', '2022-03-29 11:24:19');
INSERT INTO `sys_logininfor` VALUES (135, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 12:48:57');
INSERT INTO `sys_logininfor` VALUES (136, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 15:08:42');
INSERT INTO `sys_logininfor` VALUES (137, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 16:18:32');
INSERT INTO `sys_logininfor` VALUES (138, 'admin', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '0', '登录成功', '2022-03-29 17:19:37');
INSERT INTO `sys_logininfor` VALUES (139, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:18:28');
INSERT INTO `sys_logininfor` VALUES (140, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '验证码错误', '2022-03-29 18:18:39');
INSERT INTO `sys_logininfor` VALUES (141, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:18:45');
INSERT INTO `sys_logininfor` VALUES (142, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:21:42');
INSERT INTO `sys_logininfor` VALUES (143, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:22:02');
INSERT INTO `sys_logininfor` VALUES (144, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:22:45');
INSERT INTO `sys_logininfor` VALUES (145, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 18:25:58');
INSERT INTO `sys_logininfor` VALUES (146, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-03-29 18:26:07');
INSERT INTO `sys_logininfor` VALUES (147, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:26:15');
INSERT INTO `sys_logininfor` VALUES (148, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:27:32');
INSERT INTO `sys_logininfor` VALUES (149, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:27:39');
INSERT INTO `sys_logininfor` VALUES (150, '101', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:29:43');
INSERT INTO `sys_logininfor` VALUES (151, '101', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '验证码错误', '2022-03-29 18:29:53');
INSERT INTO `sys_logininfor` VALUES (152, '101', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '验证码错误', '2022-03-29 18:29:58');
INSERT INTO `sys_logininfor` VALUES (153, '101', '127.0.0.1', '内网IP', 'Firefox 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:30:02');
INSERT INTO `sys_logininfor` VALUES (154, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '验证码已失效', '2022-03-29 18:30:18');
INSERT INTO `sys_logininfor` VALUES (155, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:30:21');
INSERT INTO `sys_logininfor` VALUES (156, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 18:30:29');
INSERT INTO `sys_logininfor` VALUES (157, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-03-29 18:30:35');
INSERT INTO `sys_logininfor` VALUES (158, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:30:44');
INSERT INTO `sys_logininfor` VALUES (159, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 18:30:49');
INSERT INTO `sys_logininfor` VALUES (160, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '验证码已失效', '2022-03-29 18:34:13');
INSERT INTO `sys_logininfor` VALUES (161, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 18:34:20');
INSERT INTO `sys_logininfor` VALUES (162, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-03-29 18:34:25');
INSERT INTO `sys_logininfor` VALUES (163, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 18:34:55');
INSERT INTO `sys_logininfor` VALUES (164, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 19:12:21');
INSERT INTO `sys_logininfor` VALUES (165, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2022-03-29 20:31:04');
INSERT INTO `sys_logininfor` VALUES (166, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 20:31:09');
INSERT INTO `sys_logininfor` VALUES (167, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-03-29 20:31:39');
INSERT INTO `sys_logininfor` VALUES (168, '101', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-03-29 20:31:46');
...
INSERT INTO `sys_menu` VALUES (2005, '农场分区更新', 2003, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'csa:farmzone:update', '#', 'admin', '2022-03-24 19:34:52', 'admin', '2022-03-29 18:38:57', '');
...
INSERT INTO `sys_menu` VALUES (2009, '菜地划分', 2002, 20, 'garden', 'csa/garden/index', NULL, 1, 0, 'C', '0', '0', 'csa:garden:query', 'table', 'admin', '2022-03-24 22:30:32', 'admin', '2022-03-29 17:21:16', '菜地划分菜单');
...
INSERT INTO `sys_oper_log` VALUES (285, '字典类型', 1, 'com.ruoyi.web.controller.system.SysDictTypeController.add()', 'POST', 1, 'admin', NULL, '/system/dict/type', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"dictName\":\"农场分区类型\",\"remark\":\"农场区域的用途类型\",\"params\":{},\"dictType\":\"csa_zone_type\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:18:20');
INSERT INTO `sys_oper_log` VALUES (286, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"0\",\"listClass\":\"default\",\"dictSort\":1,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"菜地\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:20:30');
INSERT INTO `sys_oper_log` VALUES (287, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"1\",\"listClass\":\"default\",\"dictSort\":20,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"禽舍\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:21:12');
INSERT INTO `sys_oper_log` VALUES (288, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"0\",\"listClass\":\"default\",\"dictSort\":10,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"菜地\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473630000,\"dictCode\":100,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:21:33');
INSERT INTO `sys_oper_log` VALUES (289, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"1\",\"listClass\":\"default\",\"dictSort\":20,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"果园\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473672000,\"dictCode\":101,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:22:26');
INSERT INTO `sys_oper_log` VALUES (290, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"2\",\"listClass\":\"default\",\"dictSort\":30,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"禽舍\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:22:36');
INSERT INTO `sys_oper_log` VALUES (291, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"0\",\"listClass\":\"success\",\"dictSort\":10,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"菜地\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473630000,\"dictCode\":100,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:22:48');
INSERT INTO `sys_oper_log` VALUES (292, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"1\",\"listClass\":\"warning\",\"dictSort\":20,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"果园\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473672000,\"dictCode\":101,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:22:55');
INSERT INTO `sys_oper_log` VALUES (293, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"1\",\"listClass\":\"danger\",\"dictSort\":20,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"果园\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473672000,\"dictCode\":101,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:23:00');
INSERT INTO `sys_oper_log` VALUES (294, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"2\",\"listClass\":\"primary\",\"dictSort\":30,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"禽舍\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473755000,\"dictCode\":102,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:23:06');
INSERT INTO `sys_oper_log` VALUES (295, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"2\",\"listClass\":\"info\",\"dictSort\":30,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"禽舍\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473755000,\"dictCode\":102,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:23:12');
INSERT INTO `sys_oper_log` VALUES (296, '字典数据', 2, 'com.ruoyi.web.controller.system.SysDictDataController.edit()', 'PUT', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"2\",\"listClass\":\"primary\",\"dictSort\":30,\"params\":{},\"dictType\":\"csa_zone_type\",\"dictLabel\":\"禽舍\",\"createBy\":\"admin\",\"default\":false,\"isDefault\":\"N\",\"createTime\":1648473755000,\"dictCode\":102,\"updateBy\":\"admin\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:23:17');
INSERT INTO `sys_oper_log` VALUES (297, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.synchDb()', 'GET', 1, 'admin', NULL, '/tool/gen/synchDb/csa_zone', '127.0.0.1', '内网IP', '{tableName=csa_zone}', NULL, 1, '同步数据失败，原表结构不存在', '2022-03-28 21:38:20');
INSERT INTO `sys_oper_log` VALUES (298, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"required\":false,\"superColumn\":false,\"isInsert\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"分区代码\",\"updateTime\":1648385379000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648120612000,\"tableId\":1,\"pk\":true,\"columnName\":\"code\"},{\"capJavaField\":\"Type\",\"usableColumn\":false,\"columnId\":341,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"type\",\"htmlType\":\"select\",\"edit\":true,\"query\":true,\"columnComment\":\"分区类型\",\"isQuery\":\"1\",\"updateTime\":1648385379000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648385270000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"type\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区名称\",\"isQuery\":\"1\",\"updateTime\":1648385379000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(50)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1648120612000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"name\"},{\"capJavaField\":\"Status\",\"usableColumn\":false,\"columnId\":3,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"isInsert\":\"1\",\"javaField\":\"status\",\"htmlType\":\"radio\",\"edit\":true,\"query\":true,\"columnComment\":\"状态（0正常 1停用）\",\"isQuery\":\"1\",\"updateTime\":1648385379000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:38:33');
INSERT INTO `sys_oper_log` VALUES (299, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.synchDb()', 'GET', 1, 'admin', NULL, '/tool/gen/synchDb/csa_farm_zone', '127.0.0.1', '内网IP', '{tableName=csa_farm_zone}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:38:50');
INSERT INTO `sys_oper_log` VALUES (300, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":342,\"isIncrement\":\"1\",\"increment\":true,\"insert\":true,\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"分区id\",\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"1\",\"createTime\":1648474730000,\"tableId\":1,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区代码\",\"isQuery\":\"1\",\"updateTime\":1648474730000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648120612000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":true,\"columnName\":\"code\"},{\"capJavaField\":\"Type\",\"usableColumn\":false,\"columnId\":341,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"type\",\"htmlType\":\"select\",\"edit\":true,\"query\":true,\"columnComment\":\"分区类型\",\"isQuery\":\"1\",\"updateTime\":1648474730000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648385270000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"type\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区名称\",\"isQuery\":\"1\",\"updateTime\":1648474730000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(50)\",\"create', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:39:03');
INSERT INTO `sys_oper_log` VALUES (301, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":342,\"isIncrement\":\"1\",\"increment\":true,\"insert\":true,\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"分区id\",\"updateTime\":1648474743000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"1\",\"createTime\":1648474730000,\"tableId\":1,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区代码\",\"isQuery\":\"1\",\"updateTime\":1648474743000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648120612000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":true,\"columnName\":\"code\"},{\"capJavaField\":\"Type\",\"usableColumn\":false,\"columnId\":341,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"type\",\"htmlType\":\"select\",\"edit\":true,\"query\":true,\"columnComment\":\"分区类型\",\"isQuery\":\"1\",\"updateTime\":1648474743000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648385270000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"type\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区名称\",\"isQuery\":\"1\",\"updateTime\":1648474743000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"column', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:40:15');
INSERT INTO `sys_oper_log` VALUES (302, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', NULL, 0, NULL, '2022-03-28 21:40:20');
INSERT INTO `sys_oper_log` VALUES (303, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":342,\"isIncrement\":\"1\",\"increment\":true,\"insert\":true,\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"分区id\",\"updateTime\":1648474815000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"1\",\"createTime\":1648474730000,\"tableId\":1,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区代码\",\"isQuery\":\"1\",\"updateTime\":1648474815000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648120612000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":true,\"columnName\":\"code\"},{\"capJavaField\":\"Type\",\"usableColumn\":false,\"columnId\":341,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"csa_zone_type\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"type\",\"htmlType\":\"select\",\"edit\":true,\"query\":true,\"columnComment\":\"分区类型\",\"isQuery\":\"1\",\"updateTime\":1648474815000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648385270000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"type\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区名称\",\"isQuery\":\"1\",\"updateTime\":1648474815000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"Strin', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 21:54:34');
INSERT INTO `sys_oper_log` VALUES (304, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":342,\"isIncrement\":\"1\",\"increment\":true,\"insert\":true,\"dictType\":\"\",\"required\":false,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"分区id\",\"updateTime\":1648475674000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"1\",\"createTime\":1648474730000,\"tableId\":1,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":1,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区代码\",\"isQuery\":\"1\",\"updateTime\":1648475674000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648120612000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":true,\"columnName\":\"code\"},{\"capJavaField\":\"Type\",\"usableColumn\":false,\"columnId\":341,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"csa_zone_type\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"type\",\"htmlType\":\"select\",\"edit\":true,\"query\":true,\"columnComment\":\"分区类型\",\"isQuery\":\"1\",\"updateTime\":1648475674000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(10)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648385270000,\"isEdit\":\"1\",\"tableId\":1,\"pk\":false,\"columnName\":\"type\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":2,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"分区名称\",\"isQuery\":\"1\",\"updateTime\":1648475674000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"Strin', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 22:04:22');
INSERT INTO `sys_oper_log` VALUES (305, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"code\":\"default\",\"remark\":\"基础版只支持一个农场分区\",\"updateTime\":1648477071042,\"delFlag\":\"0\",\"params\":{},\"type\":\"0\",\"createBy\":\"\",\"updateBy\":\"\",\"name\":\"默认农场\",\"id\":1,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 22:17:51');
INSERT INTO `sys_oper_log` VALUES (306, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"code\":\"default\",\"remark\":\"基础版只支持一个农场分区\",\"updateTime\":1648477296377,\"delFlag\":\"0\",\"params\":{},\"type\":\"0\",\"createBy\":\"\",\"updateBy\":\"\",\"name\":\"默认分区\",\"id\":1,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-28 22:21:36');
INSERT INTO `sys_oper_log` VALUES (307, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"updateBy\":\"\",\"name\":\"默认分区\",\"remark\":\"基础版只支持一个农场分区\",\"updateTime\":1648520890563,\"id\":1,\"delFlag\":\"0\",\"params\":{},\"type\":\"0\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 10:28:10');
INSERT INTO `sys_oper_log` VALUES (308, '农场分区', 1, 'com.jlt.csa.controller.FarmZoneController.add()', 'POST', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createTime\":1648524320660,\"name\":\"苹果园\",\"remark\":\"共享苹果园\",\"id\":2,\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:25:20');
INSERT INTO `sys_oper_log` VALUES (309, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"updateBy\":\"\",\"name\":\"共享菜园\",\"remark\":\"基础版只支持一个农场分区\",\"updateTime\":1648524876048,\"id\":1,\"delFlag\":\"0\",\"params\":{},\"type\":\"0\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:34:36');
INSERT INTO `sys_oper_log` VALUES (310, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"updateBy\":\"\",\"name\":\"一号菜园\",\"remark\":\"基础版只支持一个农场分区\",\"updateTime\":1648524900648,\"id\":1,\"delFlag\":\"0\",\"params\":{},\"type\":\"0\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:35:00');
INSERT INTO `sys_oper_log` VALUES (311, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"createTime\":1648524321000,\"updateBy\":\"\",\"name\":\"高山苹果园\",\"remark\":\"共享苹果园\",\"updateTime\":1648524918990,\"id\":2,\"delFlag\":\"0\",\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:35:19');
INSERT INTO `sys_oper_log` VALUES (312, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, 'admin', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"createTime\":1648524321000,\"updateBy\":\"\",\"name\":\"高山苹果园\",\"remark\":\"后山山顶的共享苹果园\",\"updateTime\":1648524934764,\"id\":2,\"delFlag\":\"0\",\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:35:34');
INSERT INTO `sys_oper_log` VALUES (313, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.synchDb()', 'GET', 1, 'admin', NULL, '/tool/gen/synchDb/csa_garden', '127.0.0.1', '内网IP', '{tableName=csa_garden}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:37:14');
INSERT INTO `sys_oper_log` VALUES (314, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":10,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"required\":false,\"superColumn\":false,\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"菜地id\",\"updateTime\":1648525034000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648131812000,\"tableId\":2,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"ZoneId\",\"usableColumn\":false,\"columnId\":343,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"zoneId\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"农场分区\",\"isQuery\":\"1\",\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648525034000,\"isEdit\":\"1\",\"tableId\":2,\"pk\":false,\"columnName\":\"zone_id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":11,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"菜地编号\",\"isQuery\":\"1\",\"updateTime\":1648525034000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(20)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1648131812000,\"isEdit\":\"1\",\"tableId\":2,\"pk\":false,\"columnName\":\"code\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":13,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"菜地名称\",\"isQuery\":\"1\",\"updateTime\":1648525034000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"LIKE\",\"columnType\":\"varchar(50', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 11:39:14');
INSERT INTO `sys_oper_log` VALUES (315, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":10,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"required\":false,\"superColumn\":false,\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"菜地id\",\"updateTime\":1648525153000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648131812000,\"tableId\":2,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"ZoneId\",\"usableColumn\":false,\"columnId\":343,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"zoneId\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"农场分区\",\"isQuery\":\"1\",\"updateTime\":1648525153000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648525034000,\"isEdit\":\"1\",\"tableId\":2,\"pk\":false,\"columnName\":\"zone_id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":11,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"菜地编号\",\"isQuery\":\"1\",\"updateTime\":1648525153000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(20)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1648131812000,\"isEdit\":\"1\",\"tableId\":2,\"pk\":false,\"columnName\":\"code\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":13,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"菜地名称\",\"isQuery\":\"1\",\"updateTime\":1648525154000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"LIK', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 12:03:38');
INSERT INTO `sys_oper_log` VALUES (316, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{\"sub\":false,\"functionAuthor\":\"郏磊涛\",\"columns\":[{\"capJavaField\":\"Id\",\"usableColumn\":false,\"columnId\":10,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"required\":false,\"superColumn\":false,\"isInsert\":\"1\",\"javaField\":\"id\",\"htmlType\":\"input\",\"edit\":false,\"query\":false,\"columnComment\":\"菜地id\",\"updateTime\":1648526618000,\"sort\":1,\"list\":false,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"admin\",\"isPk\":\"1\",\"createTime\":1648131812000,\"tableId\":2,\"pk\":true,\"columnName\":\"id\"},{\"capJavaField\":\"ZoneId\",\"usableColumn\":false,\"columnId\":343,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"updateBy\":\"\",\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"zoneId\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"农场分区\",\"isQuery\":\"1\",\"updateTime\":1648526618000,\"sort\":2,\"list\":true,\"params\":{},\"javaType\":\"Long\",\"queryType\":\"EQ\",\"columnType\":\"int(11)\",\"createBy\":\"\",\"isPk\":\"0\",\"createTime\":1648525034000,\"isEdit\":\"1\",\"tableId\":2,\"pk\":false,\"columnName\":\"zone_id\"},{\"capJavaField\":\"Code\",\"usableColumn\":false,\"columnId\":11,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"code\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"菜地编号\",\"isQuery\":\"1\",\"updateTime\":1648526618000,\"sort\":3,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"EQ\",\"columnType\":\"varchar(20)\",\"createBy\":\"admin\",\"isPk\":\"0\",\"createTime\":1648131812000,\"isEdit\":\"1\",\"tableId\":2,\"pk\":false,\"columnName\":\"code\"},{\"capJavaField\":\"Name\",\"usableColumn\":false,\"columnId\":13,\"isIncrement\":\"0\",\"increment\":false,\"insert\":true,\"isList\":\"1\",\"dictType\":\"\",\"required\":true,\"superColumn\":false,\"isInsert\":\"1\",\"isRequired\":\"1\",\"javaField\":\"name\",\"htmlType\":\"input\",\"edit\":true,\"query\":true,\"columnComment\":\"菜地名称\",\"isQuery\":\"1\",\"updateTime\":1648526618000,\"sort\":4,\"list\":true,\"params\":{},\"javaType\":\"String\",\"queryType\":\"LIK', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 12:05:51');
INSERT INTO `sys_oper_log` VALUES (317, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8003\",\"m2\":30,\"params\":{},\"createTime\":1648530868900,\"zoneId\":1,\"isCompleted\":\"N\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'name\' doesn\'t have a default value\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.insertGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into csa_garden          ( zone_id,             code,                          m2,                                                                                           is_completed,                                                    create_time )           values ( ?,             ?,                          ?,                                                                                           ?,                                                    ? )\r\n### Cause: java.sql.SQLException: Field \'name\' doesn\'t have a default value\n; Field \'name\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'name\' doesn\'t have a default value', '2022-03-29 13:14:29');
INSERT INTO `sys_oper_log` VALUES (318, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8003\",\"m2\":30,\"params\":{},\"createTime\":1648530872856,\"zoneId\":1,\"isCompleted\":\"N\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'name\' doesn\'t have a default value\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.insertGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into csa_garden          ( zone_id,             code,                          m2,                                                                                           is_completed,                                                    create_time )           values ( ?,             ?,                          ?,                                                                                           ?,                                                    ? )\r\n### Cause: java.sql.SQLException: Field \'name\' doesn\'t have a default value\n; Field \'name\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'name\' doesn\'t have a default value', '2022-03-29 13:14:32');
INSERT INTO `sys_oper_log` VALUES (319, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8003\",\"m2\":30,\"params\":{},\"createTime\":1648530875929,\"zoneId\":1,\"isCompleted\":\"N\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'name\' doesn\'t have a default value\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.insertGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into csa_garden          ( zone_id,             code,                          m2,                                                                                           is_completed,                                                    create_time )           values ( ?,             ?,                          ?,                                                                                           ?,                                                    ? )\r\n### Cause: java.sql.SQLException: Field \'name\' doesn\'t have a default value\n; Field \'name\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'name\' doesn\'t have a default value', '2022-03-29 13:14:35');
INSERT INTO `sys_oper_log` VALUES (320, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8003\",\"m2\":30,\"params\":{},\"createTime\":1648530942882,\"zoneId\":1,\"isCompleted\":\"N\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 13:15:42');
INSERT INTO `sys_oper_log` VALUES (321, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648530970720,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"0\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"0\",\"name\":\"香草居\",\"zoneId\":1,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 13:16:10');
INSERT INTO `sys_oper_log` VALUES (322, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8001\",\"m2\":30,\"updateTime\":1648530975891,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"0\",\"createBy\":\"\",\"createTime\":1648207912000,\"updateBy\":\"\",\"isSelled\":\"0\",\"name\":\"百草园\",\"zoneId\":1,\"id\":1,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 13:16:15');
INSERT INTO `sys_oper_log` VALUES (323, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"params\":{},\"createTime\":1648531238042,\"zoneId\":1,\"isCompleted\":\"N\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 13:20:38');
INSERT INTO `sys_oper_log` VALUES (324, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648537745696,\"params\":{},\"isCompleted\":\"Y\"} [4]', NULL, 1, 'nested exception is org.apache.ibatis.binding.BindingException: Parameter \'isFarming\' not found. Available parameters are [ids, garden, param1, param2]', '2022-03-29 15:09:05');
INSERT INTO `sys_oper_log` VALUES (325, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648538068904,\"params\":{},\"isCompleted\":\"Y\"} [4]', NULL, 1, 'nested exception is org.apache.ibatis.binding.BindingException: Parameter \'array\' not found. Available parameters are [ids, garden, param1, param2]', '2022-03-29 15:14:28');
INSERT INTO `sys_oper_log` VALUES (326, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648538129915,\"params\":{},\"isCompleted\":\"Y\"} [4]', NULL, 1, 'nested exception is org.apache.ibatis.binding.BindingException: Parameter \'array\' not found. Available parameters are [ids, garden, param1, param2]', '2022-03-29 15:15:29');
INSERT INTO `sys_oper_log` VALUES (327, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648538153560,\"params\":{},\"isCompleted\":\"Y\"} [4]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 15:15:53');
INSERT INTO `sys_oper_log` VALUES (328, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648538507993,\"params\":{},\"isCompleted\":\"Y\"} [4]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 15:21:48');
INSERT INTO `sys_oper_log` VALUES (329, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648538846824,\"params\":{},\"isCompleted\":\"Y\"} [4]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 15:27:26');
INSERT INTO `sys_oper_log` VALUES (330, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/4', '127.0.0.1', '内网IP', '{\"updateTime\":1648538934371,\"params\":{},\"isCompleted\":\"Y\"} [4]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 15:28:54');
INSERT INTO `sys_oper_log` VALUES (331, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/3,2', '127.0.0.1', '内网IP', '{\"updateTime\":1648539308218,\"params\":{},\"isCompleted\":\"Y\"} [3,2]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 15:35:08');
INSERT INTO `sys_oper_log` VALUES (332, '农场分区', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, 'admin', NULL, '/csa/garden/1', '127.0.0.1', '内网IP', '{\"updateTime\":1648539354383,\"params\":{},\"isCompleted\":\"Y\"} [1]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 15:35:54');
INSERT INTO `sys_oper_log` VALUES (333, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648542209470,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.updateGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: update csa_garden          SET zone_id = ?,             code = ?,             ?,             m2 = ?,                                                                 is_farming = ?,             is_selled = ?,             is_completed = ?,             status = ?,             del_flag = ?,             create_by = ?,             create_time = ?,             update_by = ?,             update_time = ?          where id = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4', '2022-03-29 16:23:29');
INSERT INTO `sys_oper_log` VALUES (334, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648542214328,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.updateGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: update csa_garden          SET zone_id = ?,             code = ?,             ?,             m2 = ?,                                                                 is_farming = ?,             is_selled = ?,             is_completed = ?,             status = ?,             del_flag = ?,             create_by = ?,             create_time = ?,             update_by = ?,             update_time = ?          where id = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4', '2022-03-29 16:23:34');
INSERT INTO `sys_oper_log` VALUES (335, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8003\",\"m2\":30,\"updateTime\":1648542787679,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648530943000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":3,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 16:33:07');
INSERT INTO `sys_oper_log` VALUES (336, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648542792904,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.updateGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: update csa_garden          SET zone_id = ?,             code = ?,             ?,             m2 = ?,                                                                 is_farming = ?,             is_selled = ?,             is_completed = ?,             status = ?,             del_flag = ?,             create_by = ?,             create_time = ?,             update_by = ?,             update_time = ?          where id = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4', '2022-03-29 16:33:12');
INSERT INTO `sys_oper_log` VALUES (337, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648542797949,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 16:33:18');
INSERT INTO `sys_oper_log` VALUES (338, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648542801287,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.updateGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: update csa_garden          SET zone_id = ?,             code = ?,             ?,             m2 = ?,                                                                 is_farming = ?,             is_selled = ?,             is_completed = ?,             status = ?,             del_flag = ?,             create_by = ?,             create_time = ?,             update_by = ?,             update_time = ?          where id = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4', '2022-03-29 16:33:21');
INSERT INTO `sys_oper_log` VALUES (339, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648543446098,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\r\n### The error may exist in file [D:\\Projects\\私家农场\\Private-Farm\\private-farm\\target\\classes\\mapper\\csa\\GardenMapper.xml]\r\n### The error may involve com.jlt.csa.mapper.GardenMapper.updateGarden-Inline\r\n### The error occurred while setting parameters\r\n### SQL: update csa_garden          SET zone_id = ?,             code = ?,             ?,             m2 = ?,                                                                 is_farming = ?,             is_selled = ?,             is_completed = ?,             status = ?,             del_flag = ?,             create_by = ?,             create_time = ?,             update_by = ?,             update_time = ?          where id = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'香草居\',\n            m2 = 30,\n            \n            \n            \n       \' at line 4', '2022-03-29 16:44:06');
INSERT INTO `sys_oper_log` VALUES (340, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648543479785,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 16:44:39');
INSERT INTO `sys_oper_log` VALUES (341, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648543483985,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 16:44:44');
INSERT INTO `sys_oper_log` VALUES (342, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8003\",\"m2\":30,\"updateTime\":1648543486786,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648530943000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":3,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 16:44:46');
INSERT INTO `sys_oper_log` VALUES (343, '菜地划分', 5, 'com.jlt.csa.controller.GardenController.export()', 'POST', 1, 'admin', NULL, '/csa/garden/export', '127.0.0.1', '内网IP', '{\"params\":{}}', NULL, 0, NULL, '2022-03-29 16:44:52');
INSERT INTO `sys_oper_log` VALUES (344, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648543873401,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 16:51:14');
INSERT INTO `sys_oper_log` VALUES (345, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648545182508,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:13:02');
INSERT INTO `sys_oper_log` VALUES (346, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":2,\"menuName\":\"菜地划分新增\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2011,\"menuType\":\"F\",\"perms\":\"csa:garden:partition\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:13:54');
INSERT INTO `sys_oper_log` VALUES (347, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2012', '127.0.0.1', '内网IP', '{menuId=2012}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:14:00');
INSERT INTO `sys_oper_log` VALUES (348, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2013', '127.0.0.1', '内网IP', '{menuId=2013}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:14:03');
INSERT INTO `sys_oper_log` VALUES (349, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":1,\"menuName\":\"菜地查询\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2010,\"menuType\":\"F\",\"perms\":\"csa:garden:query\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:14:28');
INSERT INTO `sys_oper_log` VALUES (350, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":2,\"menuName\":\"菜地划分\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2011,\"menuType\":\"F\",\"perms\":\"csa:garden:partition\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:14:35');
INSERT INTO `sys_oper_log` VALUES (351, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":5,\"menuName\":\"菜地导出\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132233000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2014,\"menuType\":\"F\",\"perms\":\"csa:garden:export\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:14:43');
INSERT INTO `sys_oper_log` VALUES (352, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":10,\"menuName\":\"菜地查询\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2010,\"menuType\":\"F\",\"perms\":\"csa:garden:query\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:15:05');
INSERT INTO `sys_oper_log` VALUES (353, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"tab\",\"orderNum\":10,\"menuName\":\"农场分区\",\"params\":{},\"parentId\":2002,\"isCache\":\"0\",\"path\":\"farmzone\",\"component\":\"csa/farmzone/index\",\"children\":[],\"createTime\":1648121692000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2003,\"menuType\":\"C\",\"perms\":\"csa:farmzone:list\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:15:27');
INSERT INTO `sys_oper_log` VALUES (354, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"table\",\"orderNum\":20,\"menuName\":\"菜地划分\",\"params\":{},\"parentId\":2002,\"isCache\":\"0\",\"path\":\"garden\",\"component\":\"csa/garden/index\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2009,\"menuType\":\"C\",\"perms\":\"csa:garden:list\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:15:37');
INSERT INTO `sys_oper_log` VALUES (355, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"documentation\",\"orderNum\":30,\"menuName\":\"作物档案\",\"params\":{},\"parentId\":2002,\"isCache\":\"0\",\"path\":\"cropfiles\",\"component\":\"csa/cropfiles/index\",\"children\":[],\"createTime\":1648218359000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2015,\"menuType\":\"C\",\"perms\":\"csa:cropfiles:list\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:15:45');
INSERT INTO `sys_oper_log` VALUES (356, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":20,\"menuName\":\"菜地划分\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2011,\"menuType\":\"F\",\"perms\":\"csa:garden:partition\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:16:30');
INSERT INTO `sys_oper_log` VALUES (357, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":30,\"menuName\":\"菜地导出\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132233000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2014,\"menuType\":\"F\",\"perms\":\"csa:garden:export\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:16:36');
INSERT INTO `sys_oper_log` VALUES (358, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648545444098,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:17:24');
INSERT INTO `sys_oper_log` VALUES (359, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648545486451,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:18:06');
INSERT INTO `sys_oper_log` VALUES (360, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"table\",\"orderNum\":20,\"menuName\":\"菜地划分\",\"params\":{},\"parentId\":2002,\"isCache\":\"0\",\"path\":\"garden\",\"component\":\"csa/garden/index\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2009,\"menuType\":\"C\",\"perms\":\"csa:garden:query\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:21:16');
INSERT INTO `sys_oper_log` VALUES (361, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, 'admin', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648545690137,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:21:30');
INSERT INTO `sys_oper_log` VALUES (362, '角色管理', 1, 'com.ruoyi.web.controller.system.SysRoleController.add()', 'POST', 1, 'admin', NULL, '/system/role', '127.0.0.1', '内网IP', '{\"flag\":false,\"roleId\":100,\"admin\":false,\"params\":{},\"roleSort\":\"1000\",\"deptCheckStrictly\":true,\"createBy\":\"admin\",\"menuCheckStrictly\":true,\"roleKey\":\"base\",\"roleName\":\"基础角色\",\"deptIds\":[],\"menuIds\":[],\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:40:58');
INSERT INTO `sys_oper_log` VALUES (363, '角色管理', 2, 'com.ruoyi.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', NULL, '/system/role', '127.0.0.1', '内网IP', '{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"delFlag\":\"0\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":true,\"createTime\":1648546858000,\"updateBy\":\"admin\",\"menuCheckStrictly\":true,\"roleKey\":\"plan\",\"roleName\":\"园区规划员\",\"menuIds\":[],\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:45:18');
INSERT INTO `sys_oper_log` VALUES (364, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"我们的农场\",\"leader\":\"\",\"deptId\":100,\"orderNum\":\"0\",\"delFlag\":\"0\",\"params\":{},\"parentId\":0,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:46:46');
INSERT INTO `sys_oper_log` VALUES (365, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"信息部\",\"leader\":\"\",\"deptId\":101,\"orderNum\":\"90\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:47:14');
INSERT INTO `sys_oper_log` VALUES (366, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"客服部\",\"leader\":\"\",\"deptId\":102,\"orderNum\":\"10\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:48:07');
INSERT INTO `sys_oper_log` VALUES (367, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"现场部\",\"leader\":\"\",\"deptId\":109,\"orderNum\":\"20\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:48:41');
INSERT INTO `sys_oper_log` VALUES (368, '部门管理', 3, 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dept/107', '127.0.0.1', '内网IP', '{deptId=107}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:48:51');
INSERT INTO `sys_oper_log` VALUES (369, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"财务部\",\"leader\":\"\",\"deptId\":106,\"orderNum\":\"80\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:49:11');
INSERT INTO `sys_oper_log` VALUES (370, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"销售部\",\"leader\":\"\",\"deptId\":108,\"orderNum\":\"30\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:50:07');
INSERT INTO `sys_oper_log` VALUES (371, '部门管理', 3, 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dept/105', '127.0.0.1', '内网IP', '{deptId=105}', '{\"msg\":\"部门存在用户,不允许删除\",\"code\":500}', 0, NULL, '2022-03-29 17:50:29');
INSERT INTO `sys_oper_log` VALUES (372, '部门管理', 3, 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dept/104', '127.0.0.1', '内网IP', '{deptId=104}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:50:37');
INSERT INTO `sys_oper_log` VALUES (373, '部门管理', 3, 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dept/103', '127.0.0.1', '内网IP', '{deptId=103}', '{\"msg\":\"部门存在用户,不允许删除\",\"code\":500}', 0, NULL, '2022-03-29 17:50:40');
INSERT INTO `sys_oper_log` VALUES (374, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.edit()', 'PUT', 1, 'admin', NULL, '/system/user', '127.0.0.1', '内网IP', '{\"roles\":[{\"flag\":false,\"roleId\":2,\"admin\":false,\"dataScope\":\"2\",\"params\":{},\"roleSort\":\"2\",\"deptCheckStrictly\":false,\"menuCheckStrictly\":false,\"roleKey\":\"common\",\"roleName\":\"普通角色\",\"status\":\"0\"}],\"phonenumber\":\"\",\"admin\":false,\"loginDate\":1647783925000,\"remark\":\"\",\"delFlag\":\"0\",\"password\":\"\",\"updateBy\":\"admin\",\"postIds\":[2],\"loginIp\":\"127.0.0.1\",\"email\":\"\",\"nickName\":\"若依\",\"sex\":\"2\",\"deptId\":101,\"avatar\":\"\",\"dept\":{\"deptName\":\"测试部门\",\"leader\":\"若依\",\"deptId\":105,\"orderNum\":\"3\",\"params\":{},\"parentId\":101,\"children\":[],\"status\":\"0\"},\"params\":{},\"userName\":\"ry\",\"userId\":2,\"createBy\":\"admin\",\"roleIds\":[2],\"createTime\":1647783925000,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:51:59');
INSERT INTO `sys_oper_log` VALUES (375, '部门管理', 3, 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dept/105', '127.0.0.1', '内网IP', '{deptId=105}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:52:18');
INSERT INTO `sys_oper_log` VALUES (376, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"信息部\",\"leader\":\"\",\"deptId\":101,\"orderNum\":\"90\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:52:39');
INSERT INTO `sys_oper_log` VALUES (377, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"研发部\",\"leader\":\"\",\"deptId\":103,\"orderNum\":\"900\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 17:53:08');
INSERT INTO `sys_oper_log` VALUES (378, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"共享农场\",\"leader\":\"\",\"deptId\":100,\"orderNum\":\"0\",\"delFlag\":\"0\",\"params\":{},\"parentId\":0,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:00:53');
INSERT INTO `sys_oper_log` VALUES (379, '角色管理', 2, 'com.ruoyi.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', NULL, '/system/role', '127.0.0.1', '内网IP', '{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"delFlag\":\"0\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":true,\"createTime\":1648546858000,\"updateBy\":\"admin\",\"menuCheckStrictly\":true,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"menuIds\":[],\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:01:25');
INSERT INTO `sys_oper_log` VALUES (380, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":2,\"menuName\":\"农场分区新增\",\"params\":{},\"parentId\":2003,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648121692000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2005,\"menuType\":\"F\",\"perms\":\"csa:farmzone:update\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:05:12');
INSERT INTO `sys_oper_log` VALUES (381, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2006', '127.0.0.1', '内网IP', '{menuId=2006}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:05:18');
INSERT INTO `sys_oper_log` VALUES (382, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2007', '127.0.0.1', '内网IP', '{menuId=2007}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:05:23');
INSERT INTO `sys_oper_log` VALUES (383, '角色管理', 2, 'com.ruoyi.web.controller.system.SysRoleController.edit()', 'PUT', 1, 'admin', NULL, '/system/role', '127.0.0.1', '内网IP', '{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"delFlag\":\"0\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":true,\"createTime\":1648546858000,\"updateBy\":\"admin\",\"menuCheckStrictly\":true,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"menuIds\":[2002,2003,2004,2005,2008,2009,2010,2011,2014],\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:06:19');
INSERT INTO `sys_oper_log` VALUES (384, '部门管理', 2, 'com.ruoyi.web.controller.system.SysDeptController.edit()', 'PUT', 1, 'admin', NULL, '/system/dept', '127.0.0.1', '内网IP', '{\"deptName\":\"管理办\",\"leader\":\"\",\"deptId\":104,\"orderNum\":\"5\",\"delFlag\":\"0\",\"params\":{},\"parentId\":100,\"createBy\":\"admin\",\"children\":[],\"createTime\":1647783925000,\"phone\":\"\",\"updateBy\":\"admin\",\"ancestors\":\"0,100\",\"email\":\"\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:15:05');
INSERT INTO `sys_oper_log` VALUES (385, '用户管理', 1, 'com.ruoyi.web.controller.system.SysUserController.add()', 'POST', 1, 'admin', NULL, '/system/user', '127.0.0.1', '内网IP', '{\"admin\":false,\"password\":\"$2a$10$wV/TBNdR6Ia3ane.hpIr6ui0KJz8aSFm35V8BDWm5VsCYKP70jpe6\",\"postIds\":[],\"nickName\":\"场长\",\"deptId\":104,\"params\":{},\"userName\":\"101\",\"userId\":100,\"createBy\":\"admin\",\"roleIds\":[100],\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:18:01');
INSERT INTO `sys_oper_log` VALUES (386, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.resetPwd()', 'PUT', 1, 'admin', NULL, '/system/user/resetPwd', '127.0.0.1', '内网IP', '{\"admin\":false,\"password\":\"$2a$10$ldUQ6uDsDaAOwl7MC5llTe/eei5dPN.5iyT7gtXVVE2aabNNVS4ga\",\"updateBy\":\"admin\",\"params\":{},\"userId\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:19:10');
INSERT INTO `sys_oper_log` VALUES (387, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.edit()', 'PUT', 1, 'admin', NULL, '/system/user', '127.0.0.1', '内网IP', '{\"roles\":[{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":false,\"menuCheckStrictly\":false,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"status\":\"0\"}],\"phonenumber\":\"\",\"admin\":false,\"delFlag\":\"0\",\"password\":\"\",\"updateBy\":\"admin\",\"postIds\":[2],\"loginIp\":\"\",\"email\":\"\",\"nickName\":\"场长\",\"sex\":\"0\",\"deptId\":104,\"avatar\":\"\",\"dept\":{\"deptName\":\"管理办\",\"leader\":\"\",\"deptId\":104,\"orderNum\":\"5\",\"params\":{},\"parentId\":100,\"children\":[],\"status\":\"0\"},\"params\":{},\"userName\":\"101\",\"userId\":100,\"createBy\":\"admin\",\"roleIds\":[100],\"createTime\":1648549080000,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:25:49');
INSERT INTO `sys_oper_log` VALUES (388, '用户管理', 4, 'com.ruoyi.web.controller.system.SysUserController.insertAuthRole()', 'PUT', 1, 'admin', NULL, '/system/user/authRole', '127.0.0.1', '内网IP', '100 [100,2]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:27:23');
INSERT INTO `sys_oper_log` VALUES (389, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.resetPwd()', 'PUT', 1, 'admin', NULL, '/system/user/resetPwd', '127.0.0.1', '内网IP', '{\"admin\":false,\"password\":\"$2a$10$xXTIC06HnxkPu46d3Qi2He5or1wprbRnwakX1jYppYkkVZllcTL8e\",\"updateBy\":\"admin\",\"params\":{},\"userId\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:34:44');
INSERT INTO `sys_oper_log` VALUES (390, '用户管理', 4, 'com.ruoyi.web.controller.system.SysUserController.insertAuthRole()', 'PUT', 1, 'admin', NULL, '/system/user/authRole', '127.0.0.1', '内网IP', '100 [100]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:35:54');
INSERT INTO `sys_oper_log` VALUES (391, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":2,\"menuName\":\"农场分区更新\",\"params\":{},\"parentId\":2003,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648121692000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2005,\"menuType\":\"F\",\"perms\":\"csa:farmzone:update\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:38:57');
INSERT INTO `sys_oper_log` VALUES (392, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"visible\":\"0\",\"icon\":\"#\",\"orderNum\":20,\"menuName\":\"菜地划分\",\"params\":{},\"parentId\":2009,\"isCache\":\"0\",\"path\":\"#\",\"component\":\"\",\"children\":[],\"createTime\":1648132232000,\"updateBy\":\"admin\",\"isFrame\":\"1\",\"menuId\":2011,\"menuType\":\"F\",\"perms\":\"csa:garden:update\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:39:21');
INSERT INTO `sys_oper_log` VALUES (393, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, '101', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"createTime\":1648524321000,\"updateBy\":\"\",\"name\":\"高山苹果园\",\"remark\":\"后山的共享苹果园\",\"updateTime\":1648550890890,\"id\":2,\"delFlag\":\"0\",\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 18:48:11');
INSERT INTO `sys_oper_log` VALUES (394, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.edit()', 'PUT', 1, 'admin', NULL, '/system/user', '127.0.0.1', '内网IP', '{\"roles\":[{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":false,\"menuCheckStrictly\":false,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"status\":\"0\"}],\"phonenumber\":\"\",\"admin\":false,\"loginDate\":1648550096000,\"delFlag\":\"0\",\"password\":\"\",\"updateBy\":\"admin\",\"postIds\":[],\"loginIp\":\"127.0.0.1\",\"email\":\"\",\"nickName\":\"场长\",\"sex\":\"0\",\"deptId\":104,\"avatar\":\"\",\"dept\":{\"deptName\":\"管理办\",\"leader\":\"\",\"deptId\":104,\"orderNum\":\"5\",\"params\":{},\"parentId\":100,\"children\":[],\"status\":\"0\"},\"params\":{},\"userName\":\"101\",\"userId\":100,\"createBy\":\"admin\",\"roleIds\":[],\"createTime\":1648549080000,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 19:19:45');
INSERT INTO `sys_oper_log` VALUES (395, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.edit()', 'PUT', 1, 'admin', NULL, '/system/user', '127.0.0.1', '内网IP', '{\"roles\":[],\"phonenumber\":\"\",\"admin\":false,\"loginDate\":1648550096000,\"delFlag\":\"0\",\"password\":\"\",\"updateBy\":\"admin\",\"postIds\":[],\"loginIp\":\"127.0.0.1\",\"email\":\"\",\"nickName\":\"场长\",\"sex\":\"0\",\"deptId\":104,\"avatar\":\"\",\"dept\":{\"deptName\":\"管理办\",\"leader\":\"\",\"deptId\":104,\"orderNum\":\"5\",\"params\":{},\"parentId\":100,\"children\":[],\"status\":\"0\"},\"params\":{},\"userName\":\"101\",\"userId\":100,\"createBy\":\"admin\",\"roleIds\":[100],\"createTime\":1648549080000,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 19:19:53');
INSERT INTO `sys_oper_log` VALUES (396, '用户管理', 2, 'com.ruoyi.web.controller.system.SysUserController.edit()', 'PUT', 1, 'admin', NULL, '/system/user', '127.0.0.1', '内网IP', '{\"roles\":[{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":false,\"menuCheckStrictly\":false,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"status\":\"0\"}],\"phonenumber\":\"\",\"admin\":false,\"loginDate\":1648550096000,\"delFlag\":\"0\",\"password\":\"\",\"updateBy\":\"admin\",\"postIds\":[],\"loginIp\":\"127.0.0.1\",\"email\":\"\",\"nickName\":\"场长\",\"sex\":\"0\",\"deptId\":104,\"avatar\":\"\",\"dept\":{\"deptName\":\"管理办\",\"leader\":\"\",\"deptId\":104,\"orderNum\":\"5\",\"params\":{},\"parentId\":100,\"children\":[],\"status\":\"0\"},\"params\":{},\"userName\":\"101\",\"userId\":100,\"createBy\":\"admin\",\"roleIds\":[100,2],\"createTime\":1648549080000,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 19:36:42');
INSERT INTO `sys_oper_log` VALUES (397, '角色管理', 2, 'com.ruoyi.web.controller.system.SysRoleController.dataScope()', 'PUT', 1, 'admin', NULL, '/system/role/dataScope', '127.0.0.1', '内网IP', '{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"delFlag\":\"0\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":true,\"createTime\":1648546858000,\"menuCheckStrictly\":true,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"deptIds\":[],\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 19:43:57');
INSERT INTO `sys_oper_log` VALUES (398, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, '101', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"createTime\":1648524321000,\"updateBy\":\"\",\"name\":\"高山苹果园\",\"remark\":\"后山的共享苹果园\",\"updateTime\":1648557219896,\"id\":2,\"delFlag\":\"0\",\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:33:40');
INSERT INTO `sys_oper_log` VALUES (399, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, '101', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"createTime\":1648524321000,\"updateBy\":\"\",\"name\":\"高山苹果园\",\"remark\":\"后山的共享苹果园\",\"updateTime\":1648557223494,\"id\":2,\"delFlag\":\"0\",\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:33:43');
INSERT INTO `sys_oper_log` VALUES (400, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, '101', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648557230096,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:33:50');
INSERT INTO `sys_oper_log` VALUES (401, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, '101', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648557236041,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":2,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:33:56');
INSERT INTO `sys_oper_log` VALUES (402, '个人信息', 2, 'com.ruoyi.web.controller.system.SysProfileController.updateProfile()', 'PUT', 1, '101', NULL, '/system/user/profile', '127.0.0.1', '内网IP', '{\"roles\":[{\"flag\":false,\"roleId\":2,\"admin\":false,\"dataScope\":\"2\",\"params\":{},\"roleSort\":\"2\",\"deptCheckStrictly\":false,\"menuCheckStrictly\":false,\"roleKey\":\"common\",\"roleName\":\"普通角色\",\"status\":\"0\"},{\"flag\":false,\"roleId\":100,\"admin\":false,\"dataScope\":\"1\",\"params\":{},\"roleSort\":\"900\",\"deptCheckStrictly\":false,\"menuCheckStrictly\":false,\"roleKey\":\"plan\",\"roleName\":\"园区规划\",\"status\":\"0\"}],\"phonenumber\":\"18888888888\",\"admin\":false,\"loginDate\":1648557106000,\"delFlag\":\"0\",\"loginIp\":\"127.0.0.1\",\"email\":\"88@66.com\",\"nickName\":\"场长\",\"sex\":\"0\",\"deptId\":104,\"avatar\":\"\",\"dept\":{\"deptName\":\"管理办\",\"leader\":\"\",\"deptId\":104,\"orderNum\":\"5\",\"params\":{},\"parentId\":100,\"children\":[],\"status\":\"0\"},\"params\":{},\"userName\":\"101\",\"userId\":100,\"createBy\":\"admin\",\"createTime\":1648549080000,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:35:09');
INSERT INTO `sys_oper_log` VALUES (403, '用户管理', 4, 'com.ruoyi.web.controller.system.SysUserController.insertAuthRole()', 'PUT', 1, 'admin', NULL, '/system/user/authRole', '127.0.0.1', '内网IP', '100 [100]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:35:28');
INSERT INTO `sys_oper_log` VALUES (404, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, '101', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"createTime\":1648524321000,\"updateBy\":\"\",\"name\":\"高山苹果园\",\"remark\":\"后山的共享苹果园\",\"updateTime\":1648557340441,\"id\":2,\"delFlag\":\"0\",\"params\":{},\"type\":\"1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:35:40');
INSERT INTO `sys_oper_log` VALUES (405, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, '101', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8004\",\"m2\":30,\"remark\":\"\",\"updateTime\":1648557348111,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648531238000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"\",\"zoneId\":1,\"id\":4,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:35:48');
INSERT INTO `sys_oper_log` VALUES (406, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.edit()', 'PUT', 1, '101', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8002\",\"m2\":30,\"updateTime\":1648557353919,\"delFlag\":\"0\",\"params\":{},\"isFarming\":\"N\",\"createBy\":\"\",\"createTime\":1648208014000,\"updateBy\":\"\",\"isSelled\":\"N\",\"name\":\"香草居\",\"zoneId\":1,\"id\":2,\"isCompleted\":\"N\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:35:53');
INSERT INTO `sys_oper_log` VALUES (407, '农场分区', 2, 'com.jlt.csa.controller.FarmZoneController.edit()', 'PUT', 1, '101', NULL, '/csa/farmzone', '127.0.0.1', '内网IP', '{\"createBy\":\"\",\"updateBy\":\"101\",\"name\":\"一号菜园\",\"remark\":\"基础版只支持一个农场分区\",\"updateTime\":1648558411637,\"id\":1,\"delFlag\":\"0\",\"params\":{},\"type\":\"0\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 20:53:31');
INSERT INTO `sys_oper_log` VALUES (408, '菜地划分', 2, 'com.jlt.csa.controller.GardenController.updateStatus()', 'PUT', 1, '101', NULL, '/csa/garden/2,3,4', '127.0.0.1', '内网IP', '{\"updateTime\":1648559068570,\"params\":{},\"updateBy\":\"101\",\"isCompleted\":\"Y\"} [2,3,4]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 21:04:28');
INSERT INTO `sys_oper_log` VALUES (409, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, '101', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8005\",\"m2\":30,\"params\":{},\"createBy\":\"101\",\"createTime\":1648559147545,\"zoneId\":1,\"isCompleted\":\"N\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 21:05:47');
INSERT INTO `sys_oper_log` VALUES (410, '菜地划分', 1, 'com.jlt.csa.controller.GardenController.add()', 'POST', 1, '101', NULL, '/csa/garden', '127.0.0.1', '内网IP', '{\"code\":\"8006\",\"m2\":30,\"params\":{},\"createBy\":\"101\",\"createTime\":1648562831488,\"zoneId\":1,\"isCompleted\":\"N\"} {\"zoneId\":\"1\",\"code\":\"8006\",\"m2\":\"30\",\"isCompleted\":\"N\",\"amount\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2022-03-29 22:07:11');
...
INSERT INTO `sys_role` VALUES (100, '园区规划', 'plan', 900, '1', 1, 1, '0', '0', 'admin', '2022-03-29 17:40:58', 'admin', '2022-03-29 19:43:57', NULL);
