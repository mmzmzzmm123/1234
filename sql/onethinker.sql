/*
 ...
 Source Host           : 114.132.69.190:13306
...
-- ----------------------------
-- Table structure for bx_customer_info
-- ----------------------------
...
CREATE TABLE `bx_customer_info`  (
  ...
  `customer_type` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '客户类别',
  `manager` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '负责人',
  `salesperson` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '业务员',
  `product_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品类别',
  `region` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属区域',
  `delivery_type` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '送货方式',
  `contact_person` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `mobile` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `delivery_address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收货地址',
  `notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '注意事项',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '佰星-客户信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bx_customer_info
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 236 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_config` VALUES (12, '小程序APPId', 'appId', 'wx883b407ed6f14b55', 'Y', 'admin', '2023-10-22 11:58:41', 'onethinker', '2024-01-15 09:47:06', '小程序APPId');
INSERT INTO `sys_config` VALUES (13, '小程序APPSECRET', 'appsecret', 'ab42d586d05adcc04c6d8c7e048792cd', 'Y', 'admin', '2023-10-22 11:58:41', 'onethinker', '2024-01-15 09:47:14', '小程序APPSECRET');
INSERT INTO `sys_config` VALUES (14, '默认上传图片目录', 'detail_file_path', '/onethinker/public/ywkj', 'Y', 'admin', '2023-10-22 11:58:41', 'onethinker', '2023-11-06 23:11:13', '默认图片地址');
...
INSERT INTO `sys_config` VALUES (17, '服务器文件前缀', 'service_file_public_url', 'http://114.132.69.190:8081', 'Y', 'onethinker', '2023-11-05 17:04:15', 'onethinker', '2023-11-07 21:48:36', '服务器文件前缀');
INSERT INTO `sys_config` VALUES (18, '验证码发送次数', 'code_mail_count', '10', 'Y', 'onethinker', '2024-01-16 14:09:23', '', NULL, '验证码发送次数');
INSERT INTO `sys_config` VALUES (19, '验证码内容', 'code_mail_format', '【扬万科技】%s为本次验证的验证码，请在5分钟内完成验证。为保证账号安全，请勿泄漏此验证码。', 'Y', 'onethinker', '2024-01-16 14:09:52', '', NULL, '验证码内容');
INSERT INTO `sys_config` VALUES (20, '邮箱发送人', 'send_mailer', '2689725568@qq.com', 'Y', 'onethinker', '2024-01-16 14:10:08', '', NULL, '邮箱发送人');
INSERT INTO `sys_config` VALUES (21, '管理员id', 'admin_user_id', '1', 'Y', 'onethinker', '2024-01-16 17:07:46', '', NULL, '管理员id');
INSERT INTO `sys_config` VALUES (22, '订阅信息格式化', 'subscribe_format', '【扬万科技】您订阅的专栏【%s】新增一篇文章：%s。', 'Y', 'onethinker', '2024-01-18 16:33:12', '', NULL, '订阅信息格式化');
...
INSERT INTO `sys_job` VALUES (4, '创建红包明细数据', 'DEFAULT', 'redEnvelopeDtlTask.createRedEnvelopDtlTask()', '3 0/5 * * * ?', '1', '0', '1', 'onethinker', '2023-11-04 16:10:25', 'onethinker', '2023-11-04 17:08:12', '');
INSERT INTO `sys_job` VALUES (5, '创建二维码数据', 'DEFAULT', 'redEnvelopeDtlTask.createQrCode()', '7 0/3 * * * ?', '1', '0', '1', 'onethinker', '2023-11-04 16:11:31', 'onethinker', '2023-11-04 17:15:36', '');
INSERT INTO `sys_job` VALUES (6, '发送天气预报模块消息', 'SYSTEM', 'SubscribeTemplateTask.sendSubscribeTemplateByWeatherInfo()', '0 0 7 * * ?', '1', '1', '1', 'onethinker', '2024-03-15 14:05:00', '', '2024-03-15 14:05:04', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1111 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (1087, '领取明细', 1071, 1, 'winner', 'onethinker/winner/index', NULL, 1, 0, 'C', '0', '0', 'onethinker:winner:list', '#', 'admin', '2023-11-04 17:28:03', '', NULL, '领取明细菜单');
INSERT INTO `sys_menu` VALUES (1088, '领取明细查询', 1087, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:winner:query', '#', 'admin', '2023-11-04 17:28:04', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1089, '领取明细新增', 1087, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:winner:add', '#', 'admin', '2023-11-04 17:28:04', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1090, '领取明细修改', 1087, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:winner:edit', '#', 'admin', '2023-11-04 17:28:04', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1091, '领取明细删除', 1087, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:winner:remove', '#', 'admin', '2023-11-04 17:28:04', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1092, '领取明细导出', 1087, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:winner:export', '#', 'admin', '2023-11-04 17:28:04', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1093, '订阅消息控制', 1071, 1, 'ctrl', 'onethinker/ctrl/index', NULL, 1, 0, 'C', '0', '0', 'onethinker:ctrl:list', '#', 'admin', '2024-01-15 15:09:15', '', NULL, '订阅消息控制菜单');
INSERT INTO `sys_menu` VALUES (1094, '订阅消息控制查询', 1093, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:ctrl:query', '#', 'admin', '2024-01-15 15:09:16', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1095, '订阅消息控制新增', 1093, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:ctrl:add', '#', 'admin', '2024-01-15 15:09:16', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1096, '订阅消息控制修改', 1093, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:ctrl:edit', '#', 'admin', '2024-01-15 15:09:16', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1097, '订阅消息控制删除', 1093, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:ctrl:remove', '#', 'admin', '2024-01-15 15:09:17', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1098, '订阅消息控制导出', 1093, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:ctrl:export', '#', 'admin', '2024-01-15 15:09:17', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1099, '天气预报最新结果', 1071, 1, 'weatherInfo', 'onethinker/weatherInfo/index', NULL, 1, 0, 'C', '0', '0', 'onethinker:weatherInfo:list', '#', 'admin', '2024-03-08 10:28:55', 'onethinker', '2024-03-08 15:09:14', '天气预报最新结果菜单');
INSERT INTO `sys_menu` VALUES (1100, '天气预报最新结果查询', 1099, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:weatherInfo:query', '#', 'admin', '2024-03-08 10:28:55', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1101, '天气预报最新结果新增', 1099, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'onethinker:weatherInfo:add', '#', 'admin', '2024-03-08 10:28:55', '', NULL, '');
...
INSERT INTO `sys_role` VALUES (3, '平台用户角色', 'pu_user', 3, '1', 1, 1, '0', '0', 'admin', '2023-10-24 17:35:36', 'onethinker', '2024-03-08 15:16:42', NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'onethinker', '超级管理员', '00', '', '18102236625', '0', '/profile/avatar/2023/10/28/blob_20231028215539A001.png', '$2a$10$yb0lVengPdH.hFjzHjpu8OW6T4Zctr4WI9p3boKwJpU.LEt2CZIq.', '0', '0', '14.145.63.161', '2024-03-21 14:22:54', 'admin', '2023-10-28 21:47:52', '', '2024-03-21 14:22:54', NULL);
INSERT INTO `sys_user` VALUES (3, 111, 'pu_user', '平台用户', '00', '', '', '2', '', '$2a$10$ejOA4VT98kvssxUgqIGTyOguJ1SPO/zCS3gx3achiHDOloFC1N9f2', '0', '0', '116.23.204.89', '2024-04-26 07:11:57', 'admin', '2023-10-24 17:33:49', 'onethinker', '2024-04-26 07:11:57', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '领取明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_file`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件Id',
  ...
  `fingerprint` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '文件指纹',
  `file_size` decimal(10, 0) NULL DEFAULT 0 COMMENT '文件大小(字节)',
  ...
  `creator_ip_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '创建人ip',
  `host_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '主机名称',
  `del_flag` decimal(1, 0) NULL DEFAULT 0 COMMENT '删除标识；1-删除, 0-可用',
  `disk_path` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '磁盘存储路径',
  `detect_mime` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '检测的MIME文件类型',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for t_file_relation
-- ----------------------------
DROP TABLE IF EXISTS `t_file_relation`;
CREATE TABLE `t_file_relation`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '关联信息ID',
  `tenant_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户ID',
  `file_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件ID',
  `relation_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关联类型',
  `relation_target` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关联类型业务ID',
  `create_time` timestamp(6) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` timestamp(6) NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` int(11) NULL DEFAULT 0 COMMENT '删除标识：1-删除, 0-正常可用',
  ...
  `update_user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新用户姓名',
  `status` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_file_relation_02`(`file_id`) USING BTREE,
  INDEX `idx_file_relation_01`(`tenant_id`, `relation_type`, `relation_target`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件关联信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_file_relation
-- ----------------------------
...
CREATE TABLE `t_platform_user`  (
  ...
  `phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户手机号 不同渠道手机号唯一',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '红包批控制表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_red_envelope_dtl`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '红包明细表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for t_subscribe_msg_ctrl
-- ----------------------------
...
CREATE TABLE `t_subscribe_msg_ctrl`  (
  ...
  `weight` bigint(20) NULL DEFAULT 0 COMMENT '权重',
  `template_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '小程序模版id',
  `page` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '模版消息跳转链接',
  `miniprogram_state` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '跳转小程序类型 跳转小程序类型：developer为开发版；trial为体验版；formal为正式版；默认为正式版',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `data` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '模板内容，不填则下发空模板,模版格式化遵循{key:{value:\"xxxx\"}}格式',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订阅消息控制表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_subscribe_msg_ctrl
-- ----------------------------
INSERT INTO `t_subscribe_msg_ctrl` VALUES (1, '2024-03-15 11:38:20', '2024-03-15 11:38:24', '', '', 1, 1, 'QVISoOJAxIH-eb3Ky-xFbmH5WcC5I1kcopworAsBfm4', 'pages/weatherinfo/index', 'trial', '这是一条模版消息', '{\"time5\":\"DATATIME\",\"thing1\":\"天气预报\",\"thing7\":\"早上好\",\"thing6\":\"{{content}}\"}');

-- ----------------------------
-- Table structure for t_subscribe_msg_send_result
-- ----------------------------
...
CREATE TABLE `t_subscribe_msg_send_result`  (
  ...
  `template_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '小程序模版id',
  `pu_user_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '平台用户',
  `send_msg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '请求内容',
  `send_result` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '请求结果',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订阅消息发送结果' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_subscribe_msg_send_result
-- ----------------------------

-- ----------------------------
-- Table structure for t_weather_info
-- ----------------------------
...
CREATE TABLE `t_weather_info`  (
  ...
  `enabled` int(11) NULL DEFAULT 1 COMMENT '是否可见，0发送失败，1发送成功',
  `weight` bigint(20) NULL DEFAULT 0 COMMENT '权重',
  `key` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '请求服务权限标识',
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '城市编码',
  `extensions` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '气象类型',
  `send_result` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '请求结果',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '天气预报最新结果' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_weather_info
-- ----------------------------
