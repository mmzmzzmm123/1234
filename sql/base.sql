...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表字段';
...
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=1080 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=152 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '100', 'onethinker', '超级管理员', '00', '', '18102236625', '0', '/profile/avatar/2023/10/28/blob_20231028215539A001.png', '$2a$10$yb0lVengPdH.hFjzHjpu8OW6T4Zctr4WI9p3boKwJpU.LEt2CZIq.', '0', '0', '127.0.0.1', '2023-10-30 22:08:10', 'admin', '2023-10-28 21:47:52', '', '2023-10-30 22:08:10', null);
INSERT INTO `sys_user` VALUES ('3', '111', 'pu_user', '平台用户', '00', '', '', '2', '', '$2a$10$ejOA4VT98kvssxUgqIGTyOguJ1SPO/zCS3gx3achiHDOloFC1N9f2', '0', '0', '127.0.0.1', '2023-10-29 20:53:01', 'admin', '2023-10-24 17:33:49', 'onethinker', '2023-10-29 20:53:00', null);
...
CREATE TABLE `t_platform_user_integral_history` (
  ...
  `remark` varchar(255) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='平台用户积分流水记录表';
