...
@RocketMQMessageListener(topic = MqConstants.TOPIC_ORDER_FINISH_NOTICE, consumerGroup = MqConstants.GROUP_ORDER_FINISH_NOTICE, selectorExpression = "*")
public class OrderFinishNoticeMqConsumer implements RocketMQListener<Long> {
    ...
    public void onMessage(Long orderId) {
        log.info("mq消费-订单完成通知：开始，参数：{}", orderId);
