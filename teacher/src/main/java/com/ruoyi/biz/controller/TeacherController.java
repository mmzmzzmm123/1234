...
import com.ruoyi.biz.service.ITeacherService;
...
public class TeacherController extends BaseController
{
     ...
     * 查询老师信息列表
     */
    @PreAuthorize("@ss.hasPermi('biz:teacher:list')")
    @GetMapping("/list")
     ...
     * 导出老师信息列表
     */
    @PreAuthorize("@ss.hasPermi('biz:teacher:export')")
     ...
     * 获取老师信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('biz:teacher:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增老师信息
     */
    @PreAuthorize("@ss.hasPermi('biz:teacher:add')")
     ...
     * 修改老师信息
     */
    @PreAuthorize("@ss.hasPermi('biz:teacher:edit')")
     ...
     * 删除老师信息
     */
    @PreAuthorize("@ss.hasPermi('biz:teacher:remove')")
