...
public class getResult_fundamentalCN {
    public static Object getResultObjCN(String jsonString){
        return JSON.parseObject(jsonString, fundamentalCNResult_RootVO.class);
    }
    public static void main(String[] args) {
        ...
        fundamentalCNResult_RootVO resultvo = JSON.parseObject(temp, fundamentalCNResult_RootVO.class);
