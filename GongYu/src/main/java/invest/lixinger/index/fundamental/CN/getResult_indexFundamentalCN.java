...
public class getResult_indexFundamentalCN {
    public static Object getResultObjCN(String jsonString){
        return JSON.parseObject(jsonString, indexFundamentalCNResult_RootVO.class);
    }
    public static void main(String[] args) {
        ...
        indexFundamentalCNResult_RootVO resultvo = JSON.parseObject(temp, indexFundamentalCNResult_RootVO.class);
