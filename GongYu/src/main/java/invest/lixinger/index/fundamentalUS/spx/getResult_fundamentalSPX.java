package invest.lixinger.index.fundamentalUS.spx;
...
public class getResult_fundamentalSPX {
    public static Object getResultObj(String jsonString){
        return JSON.parseObject(jsonString, fundamentalSPXResult_RootVO.class);
    }
    public static void main(String[] args) {
        ...
        fundamentalSPXResult_RootVO resultvo = JSON.parseObject(temp, fundamentalSPXResult_RootVO.class);
