...
public class PoiDemoWordTable {
    public static void main(String[] args) throws Exception {
        final String returnurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\UpdateEmbeddedDoc_result.docx";  // 结果文件
        final String templateurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\UpdateEmbeddedDoc.docx";  // 模板文件
...
//                            cell73.getCTTc().getTcPr().setVMerge(vmergeEnd);
                        ...
                        if (text.contains("${@xlsx}")) {
                            String xlsxPath = "D:\\youxi\\jx\\UpdateEmbeddedDoc.docx";
                            run.setText("", 0);
     ...
     */
    public static void doCharts6(Map<String, POIXMLDocumentPart> chartsMap) throws IOException {
        // 数据准备
        List<String> titleArr = new ArrayList<String>();// 标题
        titleArr.add("title");
