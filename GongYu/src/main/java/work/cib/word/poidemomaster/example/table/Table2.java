package work.cib.word.poidemomaster.example.table;
...
/**
 * 表格，实现合并单元格，横竖都可以，方式2
 */
public class Table2 {
    public static void main(String[] args) throws Exception {

        final String returnurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\table2_result.docx";  // 结果文件
        final String templateurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\table2.docx";  // 模板文件
