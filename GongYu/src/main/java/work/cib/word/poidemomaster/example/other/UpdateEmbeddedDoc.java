package work.cib.word.poidemomaster.example.other;
...
public class UpdateEmbeddedDoc {
    ...
    private static final String templateurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\UpdateEmbeddedDoc.docx";  // 模板文件
    private static final String returnurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\UpdateEmbeddedDoc_result.docx";  // 结果文件
