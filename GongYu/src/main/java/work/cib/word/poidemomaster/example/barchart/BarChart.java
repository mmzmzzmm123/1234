...
public class BarChart {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String returnurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\barchart_result.docx";  // 结果文件
        final String templateurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\barchart.docx";  // 模板文件
...
//                String key = new PoiWordTools().getZeroData(poixmlDocumentPart);
    ...
    public static void doCharts3(Map<String, POIXMLDocumentPart> chartsMap) throws IOException {
        // 数据准备
        List<String> titleArr = new ArrayList<String>();// 标题
        titleArr.add("");
        titleArr.add("欠款");
    ...
    public static void doCharts4(Map<String, POIXMLDocumentPart> chartsMap) throws IOException {
        // 数据准备
        List<String> titleArr = new ArrayList<String>();// 标题
        titleArr.add("");
        titleArr.add("花呗余额");
    ...
    public static void doCharts5(Map<String, POIXMLDocumentPart> chartsMap) throws IOException {
        // 数据准备
        List<String> titleArr = new ArrayList<String>();// 标题
        titleArr.add("");
        titleArr.add("呸");
