package work.cib.word.poidemomaster.example.radarchart;
...
public class RadarChart {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String returnurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\radarchart_result.docx";  // 结果文件
        final String templateurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\radarchart.docx";  // 模板文件
