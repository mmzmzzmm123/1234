package work.cib.word.poidemomaster.example.barchart;

import org.apache.poi.ooxml.POIXMLDocumentPart;
import org.apache.poi.xwpf.usermodel.XWPFChart;
import org.apache.poi.xwpf.usermodel.XWPFDocument;
import work.cib.word.poidemomaster.util.PoiWordTools;
...
public class BarChartDynamic {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String returnurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\barchartdynamic_result.docx";  // 结果文件
        final String templateurl = "F:\\leecode\\src\\main\\java\\cib\\word\\resources\\barchartdynamic.docx";  // 模板文件
     ...
     */
    public static void doCharts(XWPFDocument doc) throws IOException {
        /**----------------------------处理图表------------------------------------**/
     ...
     * @param chartsMap
     */
    public static void doCharts1(Map<String, POIXMLDocumentPart> chartsMap) throws IOException {
        // 数据准备
        ...
        new work.cib.word.poidemomaster.util.PoiWordToolsDynamic().replaceBarCharts(poixmlDocumentPart, titleArr, fldNameArr, listItemsByType);
    }



    public static void doCharts2(Map<String, POIXMLDocumentPart> chartsMap) throws IOException {
        // 数据准备
        List<String> titleArr = new ArrayList<String>();// 标题，也就是对图表选择编辑数据后显示的表格数据的第一行
        titleArr.add("");
        titleArr.add("存款$");
        ...
        new work.cib.word.poidemomaster.util.PoiWordToolsDynamic().replaceLineCharts(poixmlDocumentPart, titleArr, fldNameArr, listItemsByType);
    }
