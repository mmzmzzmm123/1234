...
import com.onethinker.common.exception.UtilException;
...
import com.onethinker.common.utils.file.FileTypeUtils;
...
public class ExcelUtil<T> {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = OnethinkerConfig.getDownloadPath() + filename;
