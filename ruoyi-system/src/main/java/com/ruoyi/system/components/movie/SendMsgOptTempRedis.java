...
public class SendMsgOptTempRedis {
	...
	public static void set(String opt, String chatroomId, String playId, int msgSort, String robotNickName,
		...
		SpringUtils.getBean(RedisTemplate.class).opsForValue().set("ruoyi:SendMsgOptTempRedis:" + opt,
				JSON.toJSONString(entry), 60 * 60 * 24 * 5, TimeUnit.SECONDS);
	...
	public static SendMsgOptTempEntry get(String opt) {
		String v = (String) SpringUtils.getBean(RedisTemplate.class).opsForValue()
				.get("ruoyi:SendMsgOptTempRedis:" + opt);
