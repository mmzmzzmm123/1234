...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    public List<SysDictData> selectDictDataByType(String dictType) {
        ...
        if(sysDictType != null && "1".equals(sysDictType.getDictFrom()) && !StringUtils.isEmpty(sysDictType.getRemark())){
            dictDatas = dictDataMapper.selectDictDataByQuery(sysDictType.getRemark());
            return dictDatas;
        }
        return null;
    }
