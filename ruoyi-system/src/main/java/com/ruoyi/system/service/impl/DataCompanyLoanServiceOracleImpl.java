...
import com.ruoyi.system.mapper.DataCompanyLoanOracleMapper;
...
public class DataCompanyLoanServiceOracleImpl implements IDataCompanyLoanOracleService
{
    ...
    @Autowired
    private DataCompanyLoanOracleMapper dataCompanyLoanMapperOracle;
    ...
    public List<DataCompanyLoan> selectDataCompanyLoanList(DataCompanyLoan dataCompanyLoan) {
        return dataCompanyLoanMapperOracle.selectDataCompanyLoanList(dataCompanyLoan);
    }
}
