...
public interface GroupInfoService extends IService<GroupInfo> {
    ...
    GroupInfo  saveExternalGroup(String groupSerialNo,String groupName,String groupInviteLink);
    ...
    void updateNameByGroupSerialNo(String groupSerialNo,String groupName);
}
