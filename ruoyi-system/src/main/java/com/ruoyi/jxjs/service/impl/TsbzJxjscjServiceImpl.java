        ...
        for (TsbzJxjscj tsbzJxjscj : tsbzJxjscjList)
        {
            ...
            try
            {
                ...
                if (StringUtils.isNull(u))
                {
                    ...
                    successNum++;
                    successMsg.append("<br/>" + successNum + "、账号 " + tsbzJxjscj.getName() + " 导入成功");
                }
                else if (isUpdateSupport)
                {
                    ...
                    successNum++;
                    successMsg.append("<br/>" + successNum + "、账号 " + tsbzJxjscj.getName() + " 更新成功");
                }
                else
                {
                    failureNum++;
                    failureMsg.append("<br/>" + failureNum + "、账号 " + tsbzJxjscj.getName() + " 已存在");
                }
            }
            catch (Exception e)
            {
                failureNum++;
                String msg = "<br/>" + failureNum + "、账号 " + tsbzJxjscj.getName() + " 导入失败：";
