package com.onethinker.framework.web.service;
...
import com.onethinker.common.exception.user.BlackListException;
...
import com.onethinker.common.exception.user.UserNotExistsException;
import com.onethinker.common.exception.user.UserPasswordNotMatchException;
...
import com.onethinker.framework.security.context.AuthenticationContextHolder;
...
public class SysLoginService {
    ...
    public void validateCaptcha(String username, String code, String uuid) {
        ...
        if (captchaEnabled) {
            String verifyKey = CacheEnum.CAPTCHA_CODE_KEY.getCode() + StringUtils.nvl(uuid, "");
