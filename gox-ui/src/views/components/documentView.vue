  ...
  <div id="document">
    <el-row :gutter="20">
      ...
      <el-col :span="20">
        ...
        <div v-else-if="showPic"
             style="border: 1px solid #000;vertical-align:middle;background-color: #5a5e66;text-align:center;min-height:700px;overflow:auto;">
  ...
  export default {
    ...
    methods: {
      ...
      printEle() {
        ...
        print({
          type: this.printType(this.getType(label)),
          printable: process.env.VUE_APP_BASE_API + '/ele/' + id,
          showModal: true
        })
      },
      recover() {
