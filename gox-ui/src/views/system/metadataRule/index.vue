    ...
    <el-dialog :title="title" :visible.sync="open" width="1500px" append-to-body>
      <el-form ref="form" :inline="true" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="定义" prop="definition">
          <el-input v-model="form.definition" autosize style="width:200%" type="textarea" placeholder="请输入内容"
                    maxlength="200" show-word-limit/>
        </el-form-item>
        <br>
        <el-form-item label="目的" prop="purpose">
          <el-input v-model="form.purpose" autosize style="width:200%" type="textarea" placeholder="请输入内容"
                    maxlength="200" show-word-limit/>
        </el-form-item>
        <br>
        ...
        <el-form-item label="信息来源" prop="sourcesOfInformation">
          <el-input v-model="form.sourcesOfInformation" autosize style="width:200%" type="textarea"
                    placeholder="请输入内容"/>
        </el-form-item>
        <br>
