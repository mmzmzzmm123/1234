<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="系统账号" prop="appid">
        <el-input
    ...
    <el-table v-loading="loading" :data="accountList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统账号" align="center" prop="appid" />
      <el-table-column label="系统名称" align="center" prop="name" />
      <el-table-column label="系统秘钥" align="center" prop="secret" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系统秘钥" prop="secret">
          <el-input v-model="form.secret" placeholder="请输入系统秘钥" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        secret: [
          { required: true, message: "系统秘钥不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除系统APP账号编号为"' + ids + '"的数据项？').then(function() {
