<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ossList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="URL地址" align="center" prop="url" width="100">
...
<script>
import { listOss, getOss, delOss, addOss, updateOss } from "@/api/system/oss";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/oss/export', {
        ...this.queryParams
