...
public class SysRegisterService
{
	...
	public String register(WXRegisterBody registerBody){
		String msg = "";
		SysUser sysUser = new SysUser();
		sysUser.setOpenId(registerBody.getOpenId());
		sysUser.setUnionId(registerBody.getUnionId());
		...
		{
			AsyncManager.me().execute(AsyncFactory.recordLogininfor(registerBody.getOpenId(), Constants.REGISTER, MessageUtils.message("user.register.success")));
		}
		return msg;
	}
