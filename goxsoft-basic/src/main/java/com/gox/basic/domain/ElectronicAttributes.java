...
//    @Excel(name = "缩微号")
    ...
    public ElectronicAttributes(Long id, String formatInformation, String computerFileName, String computerFileSize, String documentCreatingApplication, String informationbasicDescription, Long metadataId) {
        this.id = id;
        ...
        this.informationSystemDescription = informationbasicDescription;
        this.metadataId = metadataId;
    }
    ...
    public String getInformationbasicDescription() {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("informationbasicDescription", getInformationbasicDescription())
