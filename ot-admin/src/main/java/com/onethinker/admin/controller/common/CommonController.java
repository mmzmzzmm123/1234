package com.onethinker.admin.controller.common;
...
import com.onethinker.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response) {
        try {
            ...
            String filePath = OnethinkerConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) {
        try {
            // 上传文件路径
            String filePath = OnethinkerConfig.getUploadPath();
            // 上传并返回新文件名称
