...
import com.geek.common.utils.file.FileUploadUtils;
...
{
    private static final Logger log = LoggerFactory.getLogger(Common2Controller.class);
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = MgmtConfig.getDownloadPath() + fileName;
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = MgmtConfig.getProfile();
            // 数据库资源地址
