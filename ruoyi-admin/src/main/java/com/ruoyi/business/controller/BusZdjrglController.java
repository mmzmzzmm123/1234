...
public class BusZdjrglController extends BaseController
{
    ...
    {
        startPage();
        List<BusZdjrgl> list = busZdjrglService.selectBusZdjrglList(busZdjrgl);
    ...
    {
        List<BusZdjrgl> list = busZdjrglService.selectBusZdjrglList(busZdjrgl);
        ExcelUtil<BusZdjrgl> util = new ExcelUtil<BusZdjrgl>(BusZdjrgl.class);
        return util.exportExcel(list, "zdjrgl");
    }
