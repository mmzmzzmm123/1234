...
public class SysMenuController extends BaseController {
    ...
    public Result getInfo(@PathVariable Long menuId) {
        return Result.success(this.menuService.selectMenuById(menuId));
    }
    ...
    public Result treeselect(SysMenu menu) {
        List<SysMenu> menus = this.menuService.selectMenuList(menu, this.getUserId());
        return Result.success(this.menuService.buildMenuTreeSelect(menus));
    }
    ...
    public Result roleMenuTreeselect(@PathVariable("roleId") Long roleId) {
        ...
        List<Long> checkedKeys = this.menuService.selectMenuListByRoleId(roleId);
        List<TreeSelect> menu = this.menuService.buildMenuTreeSelect(menus);
        return ResultTree.successMenus(checkedKeys, menu);
    }
