...
public class SysAuthController extends BaseController
{
    ...
    private final static Map<String, String> auths = new HashMap<String, String>();
    {
        ...
        auths.put("wechat_mp", "{\"clientId\":\"wx2171fc93eaed8be1\",\"clientSecret\":\"421cfe703214d0a3688916edff0c2933\",\"redirectUri\":\"http://127.0.0.1:81/social-login?source=wechat_mp\"}");
