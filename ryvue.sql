...
INSERT INTO `gen_table` VALUES (1,'sys_project','項目表',NULL,NULL,'SysProject','crud','com.ruoyi.system','system','project','項目','ruoyi','0','/',NULL,'admin','2021-03-01 20:11:31','',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='代码生成业务表字段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gen_table_column` VALUES (1,'1','id','项目id','bigint','Long','id','1','1',NULL,'1',NULL,NULL,NULL,'EQ','input','',1,'admin','2021-03-01 20:11:31','',NULL),(2,'1','dept_id','部门id','bigint','Long','deptId','0','0',NULL,'1','1','1','1','EQ','input','',2,'admin','2021-03-01 20:11:31','',NULL),(3,'1','user_id','用户id','bigint','Long','userId','0','0',NULL,'1','1','1','1','EQ','input','',3,'admin','2021-03-01 20:11:31','',NULL),(4,'1','name','项目名称','varchar(30)','String','name','0','0',NULL,'1','1','1','1','LIKE','input','',4,'admin','2021-03-01 20:11:31','',NULL),(5,'1','type','项目类型','varchar(30)','String','type','0','0',NULL,'1','1','1','1','EQ','select','',5,'admin','2021-03-01 20:11:31','',NULL),(6,'1','description','项目描述','varchar(255)','String','description','0','0',NULL,'1','1','1','1','EQ','input','',6,'admin','2021-03-01 20:11:31','',NULL),(7,'1','total','项目总金额','int','Long','total','0','0',NULL,'1','1','1','1','EQ','input','',7,'admin','2021-03-01 20:11:31','',NULL),(8,'1','receive','到账金额','int','Long','receive','0','0',NULL,'1','1','1','1','EQ','input','',8,'admin','2021-03-01 20:11:31','',NULL),(9,'1','phone','负责人电话','varchar(11)','String','phone','0','0',NULL,'1','1','1','1','EQ','input','',9,'admin','2021-03-01 20:11:31','',NULL),(10,'1','create_by','创建者','varchar(64)','String','createBy','0','0',NULL,'1',NULL,NULL,NULL,'EQ','input','',10,'admin','2021-03-01 20:11:31','',NULL),(11,'1','create_time','创建时间','datetime','Date','createTime','0','0',NULL,'1',NULL,NULL,NULL,'EQ','datetime','',11,'admin','2021-03-01 20:11:31','',NULL),(12,'1','update_by','更新者','varchar(64)','String','updateBy','0','0',NULL,'1','1',NULL,NULL,'EQ','input','',12,'admin','2021-03-01 20:11:31','',NULL),(13,'1','update_time','更新时间','datetime','Date','updateTime','0','0',NULL,'1','1',NULL,NULL,'EQ','datetime','',13,'admin','2021-03-01 20:11:31','',NULL);
...
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler','DESKTOP-2AHFGVF1614650727254',1614650759989,15000);
...
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1614650730000,-1,5,'PAUSED','CRON',1614650727000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1614650730000,-1,5,'PAUSED','CRON',1614650727000,0,NULL,2,''),('RuoyiScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1614650740000,-1,5,'PAUSED','CRON',1614650727000,0,NULL,2,'');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_project` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=202 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='項目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_project` VALUES (200,103,1,'测试项目test','HEND','',1000,0,'18864627990','','2021-03-01 21:14:57','','2021-03-02 09:49:55'),(201,105,2,'测试项目test123','HEND','',1000,0,'18864627991','','2021-03-02 09:32:43','','2021-03-02 09:50:03');
...
-- Dump completed on 2021-03-02 10:06:02
