  ...
  <view class="order-page">
    ...
    >
      ...
      <view class="course-content">
        ...
        ></view>
        <view class="txt-box">
          <view class="course-title txt-overflow txt-overflow-line2">{{ order.courseInfo.name }}</view>
...
export default {
  ...
  methods: {
    ...
    toOrderInfo(order) {
      uni.navigateTo({
        url: "/pages/course/orderInfo?orderId=" + order.id,
      });
    },
    toPay(order) {
    ...
    toLearningCourse(order) {
      uni.navigateTo({
        url: "/pages/course/learningCourse?courseId=" + order.courseInfo.id,
      });
    },
