...
! function (t, e) {
    ...
    return function (t) {
        ...
        e.default = (0, a.default)({
            ...
            methods: {
              test1: function(i,e,r){
                // console.log("______________");
                // console.log(i);
                // console.log(e["x"]);
                // console.log(r);
                // console.log(this.option.othColor);
                // console.log("______________");
                // console.log(this.option.ceshi)
                // console.log("标记");
                // console.log(this.option.trigger);
                if(this.option.trigger==undefined) return;


                for(let k=0;k<this.option.trigger.length;k++)
                {
                  // console.log("______________");
                  // console.log(this.option.trigger[k]);
                  if(r==this.option.trigger[k].index)
                  {
                    // console.log("进入这里了")
                    if(e[i.prop]>=this.option.trigger[k].min&&e[i.prop]<=this.option.trigger[k].max)
                    {
                      return{
                        background: this.option.trigger[k].backColor,
                        color: this.option.trigger[k].wordColor
                      }
                    }
                  }
                ...
                return n("div", {
                    ...
                    return n("div", {
                        ...
                        return [t.columnData.includes(i.prop) ? n("div", {
                            key: r,
                            class: t.b("td"),
                            style: [t.styleTdName, t.styleWidth(i),t.test1(i,e,r)]
                        }, [n("span", {
                            domProps: {
