...
export const constantRoutes = [{
    ...
    },
    {
        ...
        children: [{
            ...
            component: resolve =>
                require(["@/views/jxzxkhgl/jxzxkhfa/data"], resolve),
            name: "jxzxkhfa1",
            meta: {
                title: "考核指标",
                icon: ""
    ...
    },
    {
        ...
        children: [{
            ...
            component: resolve =>
                require(["@/views/jxzxkhgl/jxzxxxsh/data"], resolve),
            name: "jxzxxxsh1",
            meta: {
                title: "教师详情页",
                icon: ""
    ...
    // 见习之星评选方案详情
    {
        ...
        hidden: true,
        children: [{
            path: "jxzxpxfa/data/:id",
            component: resolve =>
                require(["@/views/jxjs/jxzxpxfa/data"], resolve),
            name: "jxjspxfa",
            meta: {
                title: "见习之星评选方案",
                icon: ""
    ...
    },
    {
        ...
        children: [{
            ...
            component: resolve =>
                require(["@/views/qtjskhgl/qtjskhfa/data"], resolve),
            name: "qtjskhfa1",
            meta: {
                title: "考核方案指标",
                icon: ""
    ...
    },
    {
        ...
        hidden: true,
        children: [{
            path: "qtjsxxsh/data/:id",
            component: resolve =>
                require(["@/views/qtjskhgl/qtjsxxsh/data"], resolve),
            name: "qtjsxxsh1",
            meta: {
                title: "教师详情页",
                icon: ""
