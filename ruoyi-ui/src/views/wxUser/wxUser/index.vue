    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['wxUser:wxUser:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['wxUser:wxUser:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listWxUser, getWxUser, delWxUser, addWxUser, updateWxUser } from "@/api/wxUser/wxUser";
