<template>
  ...
  <div>
    ...
    <el-row style="margin: 0 20px">
      <el-input style="width: 100%" class="input-new-tag" v-if="newQuestionVisible" v-model="newQuestionValue" ref="saveTagInput" size="small" @keyup.enter.native="handleInputConfirm"
