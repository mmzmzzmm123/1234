<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['ufreight:shelves:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['ufreight:shelves:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ufreight:shelves:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ufreight:shelves:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="shelvesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键" align="center" prop="shelfId" />
...
<script>
import { listShelves, getShelves, delShelves, addShelves, updateShelves } from "@/api/ufreight/shelves";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getShelves(shelfId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除仓库货架编号为"' + shelfIds + '"的数据项？').then(function() {
        return delShelves(shelfIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ufreight/shelves/export', {
        ...this.queryParams
