<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="城市代码" align="center" prop="code"/>
...
<script>
import {addCity, delCity, getCity, listCity, updateCity} from "@/api/system/city";
// dlzt
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除城市编号为"' + codes + '"的数据项？').then(function () {
        confirm('是否确认删除城市编号为"' + codes + '"的数据项？')
        return delCity(codes);
      }).then(() => {
        this.getList();
