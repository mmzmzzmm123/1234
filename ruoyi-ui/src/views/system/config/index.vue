<template>
  ...
  <div class="app-container">
    ...
    <el-card class="box-card loading-area">
      ...
      <div>
        <el-form ref="elForm"   size="medium" label-width="210px">
          <el-collapse >
            <el-collapse-item title="常规设置" name="1">
              <el-form-item label="密码输错多少次后锁定用户" prop="maxFailedLoginAttempts">
                <el-input-number  :min="0" placeholder="请输入错误次数"
                                 controls-position=right></el-input-number>
              </el-form-item>
              <el-form-item label="用户锁定后通知的邮箱" prop="userLockoutNotificationEmail">
                <el-input  placeholder="请输入用户锁定后通知的邮箱" clearable></el-input>
              </el-form-item>
            </el-collapse-item>
            <el-collapse-item title="密码规则设置" name="2">
              <el-form-item label="密码最小长度">
                <el-input-number   placeholder="密码长度" controls-position=right>
                </el-input-number>
              </el-form-item>
              <el-form-item label="密码需要包含的大写字母个数">
                <el-input-number  :min="0" placeholder="密码需要包含的大写字母个数"
                                 controls-position=right></el-input-number>
              </el-form-item>
              <el-form-item label="密码需要包含的小写字母个数">
                <el-input-number  :min="0" controls-position=right></el-input-number>
              </el-form-item>
