    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['office:roomorder:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['office:roomorder:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listRoomorder, getRoomorder, delRoomorder, addRoomorder, updateRoomorder } from "@/api/office/roomorder";
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.reset();
      this.open = true;
      this.title = "添加房间占用（点支付时再次校验可用性并改变状态，支付失败回滚）";
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      this.reset();
