<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['office:wxuser:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['office:wxuser:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="wxuserList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="微信app id" align="center" prop="appId" />
...
<script>
import { listWxuser, getWxuser, delWxuser, addWxuser, updateWxuser } from "@/api/office/wxuser";
