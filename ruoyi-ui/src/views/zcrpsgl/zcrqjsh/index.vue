<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handlePass"
          v-hasPermi="['zcrpsgl:zcrqjsh:passQjpsStatus']"
        >审核</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleBack"
          v-hasPermi="['zcrpsgl:zcrqjsh:backQjpsStatus']"
        >退回</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="zcrqjshList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['zcrpsgl:zcrqjsh:look']"
          >查看</el-button>
          <el-button
            size="mini"
            type="text"
...
<script>
  import { passQjpsStatus,  backQjpsStatus } from "@/api/zcrpsgl/zcrqjsh";
  import { listZcrbmsqQjsh,  getZcrbmsq } from "@/api/zcrpsgl/zcrbmsq";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listZcrbmsqQjsh(this.queryParams).then(response => {
          this.zcrqjshList = response.rows;
      ...
      qjshStatusFormat(row, column) {
        return this.selectDictLabel(this.qjshStatusOptions, row.qjshStatus);
      },
