<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handlePass"
          v-hasPermi="['zcrpsgl:zcrxxsh:passXxpsStatus']"
        >审核</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleBack"
          v-hasPermi="['zcrpsgl:zcrxxsh:backXxpsStatus']"
        >退回</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="zcrxxshList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['zcrpsgl:zcrxxsh:look']"
          >查看</el-button>
          <el-button
            size="mini"
            type="text"
