<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="教师id" prop="jsid">
        <el-input
      ...
      <el-form-item label="培训表现" prop="pxbx">
        <el-select v-model="queryParams.pxbx" placeholder="请选择培训表现" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="jxzxpxpjList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="基地校ID" align="center" prop="jdxid" />
      <el-table-column label="教师id" align="center" prop="jsid" />
      <el-table-column label="培训表现" align="center" prop="pxbx" :formatter="pxbxFormat" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="教师id" prop="jsid">
          <el-input v-model="form.jsid" placeholder="请输入教师id" />
        </el-form-item>
        <el-form-item label="培训表现" prop="pxbx">
...
<script>
import { listJxzxpxpj, getJxzxpxpj, delJxzxpxpj, addJxzxpxpj, updateJxzxpxpj, exportJxzxpxpj } from "@/api/jxjs/jxzxpxpj";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除见习之星教师培训评价编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有见习之星教师培训评价数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
