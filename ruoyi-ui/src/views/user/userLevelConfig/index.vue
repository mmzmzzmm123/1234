<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userLevelConfigList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="等级图标" align="center" prop="icoUrl" :show-overflow-tooltip="true"/>
      <el-table-column label="头像框" align="center" prop="avatarUrl" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="等级图标" prop="icoUrl">
          <el-input v-model="form.icoUrl" placeholder="请输入等级图标" />
        </el-form-item>
        <el-form-item label="头像框" prop="avatarUrl">
          <el-input v-model="form.avatarUrl" placeholder="请输入头像框" />
        </el-form-item>
      </el-form>
