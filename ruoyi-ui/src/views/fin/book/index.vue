...
<script>
import { listBook, getBook, delBook, addBook, updateBook } from "@/api/fin/book";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除记账账本编号为"' + bookIds + '"的数据项？').then(function() {
