<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键" align="center" prop="projId" />
...
<script>
import { listProject, getProject, delProject, addProject, updateProject } from "@/api/fin/project";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getProject(projId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除记账项目编号为"' + projIds + '"的数据项？').then(function() {
        return delProject(projIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('fin/project/export', {
        ...this.queryParams
