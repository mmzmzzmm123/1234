<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="banner分类" prop="bannerType" label-width="100px">
        <el-select v-model="queryParams.bannerType" placeholder="请选择banner分类" clearable>
          <el-option
            v-for="dict in dict.type.course_banner_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['course:config:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['course:config:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="banner分类" align="center" prop="bannerType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.course_banner_type" :value="scope.row.bannerType"/>
        </template>
      </el-table-column>
...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig } from "@/api/course/config";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除课程banner配置编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('course/config/export', {
        ...this.queryParams
