<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="gbjtcyList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="政治面貌" prop="zzmm">
          <el-input v-model="form.zzmm" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="是否删除" prop="isdel">
...
<script>
import { listGbjtcy, getGbjtcy, delGbjtcy, addGbjtcy, updateGbjtcy } from "@/api/gbxxgl/gbjtcy";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除家庭成员(干部管理-个人状况)编号为"' + ids + '"的数据项?', "警告", {
