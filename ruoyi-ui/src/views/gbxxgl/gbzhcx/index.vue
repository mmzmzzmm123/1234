...
export default {
  ...
  methods: {
    ...
    /** 高级查询按钮操作 */
    gjQuery() {
      if (this.showGjSearch == false) {
        this.showGjSearch = true;
        this.gjQueryName = "折叠高级查询";
        this.gjQueryIcon = "el-icon-zoom-out";
      } else {
        this.showGjSearch = false;
        this.gjQueryName = "展开高级查询";
        this.gjQueryIcon = "el-icon-zoom-in";
      }
    },
    /** 查看按钮操作 */
    handleCheck(row) {
