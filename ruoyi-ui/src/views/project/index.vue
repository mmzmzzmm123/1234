<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="项目编号" align="center" prop="dictId" />
      <el-table-column label="项目名称" align="center" prop="dictName" :show-overflow-tooltip="true" />
      <el-table-column label="项目类型" align="center" :show-overflow-tooltip="true">
